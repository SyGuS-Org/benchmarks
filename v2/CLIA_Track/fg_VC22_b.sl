...
(define-fun AllZero ((v1 Int) (v2 Int)) Bool (and (= v1 0) (= v2 0)))
(define-fun InV ((v1 Int) (v2 Int)) Bool (and (and (and (>= v1 vmin) (<= v1 vmax)) (>= v2 vmin)) (<= v2 vmax)))
(define-fun InVorZero ((v1 Int) (v2 Int)) Bool (or (InV v1 v2) (AllZero v1 v2)))
(define-fun UnsafeSame ((x1 Int) (x2 Int) (v1 Int) (v2 Int)) Bool (or (and (>= x1 x2) (>= (+ x2 v2) (+ x1 v1))) (and (>= x2 x1) (>= (+ x1 v1) (+ x2 v2)))))
(define-fun BadSame ((x1 Int) (x2 Int)) Bool (= x1 x2))
(define-fun Bad ((x1 Int) (x2 Int)) Bool (BadSame x1 x2))
