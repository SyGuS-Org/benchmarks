...
(define-fun PreF ((x Int) (n Int) (m Int) (z1 Int) (z2 Int) (z3 Int)) Bool (and (= x 0) (= m 0)))
...
(define-fun PostF ((x Int) (n Int) (m Int) (z1 Int) (z2 Int) (z3 Int)) Bool (not (and (and (>= x n) (> n 0)) (or (<= n m) (< m 0)))))
