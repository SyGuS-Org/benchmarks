...
(define-fun post-f ((invalid Int) (unowned Int) (nonexclusive Int) (exclusive Int) (RETURN Int)) Bool (=> (= RETURN 0) (and (>= exclusive 0) (>= unowned 0) (>= (+ invalid unowned exclusive nonexclusive) 1))))
