...
(define-fun all_zero ((v1 Int) (v2 Int)) Bool (and (= v1 0) (= v2 0)))
(define-fun InV ((v1 Int) (v2 Int)) Bool (and (and (and (>= v1 V_min) (<= v1 V_mux_)) (>= v2 V_min)) (<= v2 V_mux_)))
(define-fun InVorZero ((v1 Int) (v2 Int)) Bool (or (InV v1 v2) (all_zero v1 v2)))
