(set-logic BV)
(define-fun origCir ((LN2254 Bool) (k3 Bool) (k4 Bool) (k5 Bool) (k6 Bool) (k7 Bool) (LN2262 Bool) (LN2275 Bool) (LN2288 Bool) (LN2301 Bool)) Bool (xor (xor (xor (xor (and (and (and (and (and LN2254 k3) k4) k5) k6) k7) LN2262) LN2275) LN2288) LN2301))
