(set-logic BV)
(define-fun Spec ((k1 Bool) (k2 Bool) (k3 Bool) (r1 Bool) (r2 Bool) (r3 Bool) (r4 Bool)) Bool (xor (xor r1 false) (xor (xor k1 r1) (xor (xor (xor r3 (not r2)) (and (not (xor k2 r2)) (xor k3 r3))) (xor r4 (xor (and r2 (xor k3 r3)) (and r3 (xor k2 r2))))))))
