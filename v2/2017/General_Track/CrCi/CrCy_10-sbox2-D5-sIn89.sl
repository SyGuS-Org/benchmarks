(set-logic BV)
(define-fun origCir ((LN70 Bool) (LN71 Bool) (LN73 Bool) (LN74 Bool) (LN236 Bool) (LN252 Bool) (LN253 Bool)) Bool (xor LN73 (and (xor LN71 (and (xor (xor LN253 LN252) LN236) LN70)) LN74)))
