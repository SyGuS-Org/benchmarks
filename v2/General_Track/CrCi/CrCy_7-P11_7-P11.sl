(set-logic BV)
(define-fun Spec ((k1 Bool) (k2 Bool) (k3 Bool) (k4 Bool) (k5 Bool) (k6 Bool) (k7 Bool) (k8 Bool)) Int (+ (ite (xor (and k1 k5) (xor (and k4 k6) (xor (and k3 k7) (and k2 k8)))) 1 0) (+ (ite (xor (and k2 k5) (xor (and (xor k1 k4) k6) (xor (and (xor k3 k4) k7) (and (xor k2 k3) k8)))) 2 0) (+ (ite (xor (and k3 k5) (xor (and k2 k6) (xor (and (xor k3 k4) k7) (and (xor k3 k4) k8)))) 4 0) (ite (xor (and k4 k5) (xor (and k3 k6) (xor (and k2 k7) (and (xor k1 k4) k8)))) 8 0)))))
