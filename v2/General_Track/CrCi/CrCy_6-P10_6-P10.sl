(set-logic BV)
(define-fun Spec ((k1 Bool) (k2 Bool) (k3 Bool) (k4 Bool)) Int (+ (ite (xor (xor k2 (xor k3 (xor k4 (and k2 (and k3 k4))))) (xor k1 (xor (and k1 k3) (xor (and k2 k3) (and k1 (and k2 k3)))))) 1 0) (+ (ite (xor (and k2 k1) (xor (and k3 k1) (xor (and k3 k2) (xor k4 (xor (and k1 (and k2 k4)) (and k2 k4)))))) 2 0) (+ (ite (xor (and k1 k2) (xor k3 (xor (and k1 k3) (xor k4 (xor (and k1 k4) (and k1 (and k3 k4))))))) 4 0) (ite (xor (xor k2 (xor k3 (xor k4 (and k2 (and k3 k4))))) (xor (and k1 k4) (xor (and k2 k4) (and k3 k4)))) 8 0)))))
