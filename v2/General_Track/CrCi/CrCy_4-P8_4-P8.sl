(set-logic BV)
(define-fun Spec ((k1 Bool) (k2 Bool) (k3 Bool) (r1 Bool) (r2 Bool) (r3 Bool) (r4 Bool)) Bool (xor (xor r4 (xor (xor (and (or (xor r1 r2) (xor (xor r3 k3) false)) (or (xor r1 (xor r2 k2)) (xor (xor r3 k3) true))) (xor (xor r3 k3) (xor r1 k1))) (and (and (xor r2 k2) r3) (not false)))) (or r2 r3)))
