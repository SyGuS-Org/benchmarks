(set-logic BV)
(define-fun Spec ((k1 Bool) (k2 Bool) (k3 Bool) (r1 Bool) (r2 Bool) (r3 Bool) (r4 Bool)) Bool (xor (xor (xor (xor (or r2 r3) (xor (xor r3 k3) (xor r1 k1))) (and (or (xor r2 r1) (xor (xor r3 k3) false)) (or (xor r1 (xor r2 k2)) (xor (xor r3 k3) true)))) r4) (and (and r3 (xor r2 k2)) (not false))))
