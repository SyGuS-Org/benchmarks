...
(define-fun
  ...
  (let
   ((X1 Int 0))
   (let
    ((X2 Int (ite (not top.usr.onOff_a_0) 0 1)))
    (let
     ((X3
       Bool (and
             (and (>= X1 2) (<= X1 8))
             (not (ite (not (= X2 0)) true false)))))
     (let
      ((X4 Int (ite X3 (ite (and (>= X1 2) (<= X1 8)) 0 X1) X1)))
      (let
       ((X5 Int (ite X3 (ite (not (= X4 1)) 1 X4) X4)))
       (let
        ((X6
          Bool (and (= X5 1) (and (ite (not (= X2 0)) true false) (not X3)))))
        (let
         ((X7 Int (ite X6 (ite (= X5 1) 0 X5) X5)))
         (let
          ((X8 Int (ite (not (and (>= X7 2) (<= X7 8))) 2 X7)))
          (let
           ((X9
             Bool (and
                   (not (and (>= X7 2) (<= X7 8)))
                   (and (>= X8 2) (<= X8 8)))))
           (let
            ((X10 Int (ite X9 (ite (not (= X8 7)) 7 X8) X8)))
            (let
             ((X11
               Bool (or (and (>= X10 3) (<= X10 6)) (or (= X10 7) (= X10 8)))))
             (and
              (= top.usr.OK_a_0 X11)
              (let
               ((X12 Bool false))
                ...
                (let
                 ...
                 (and
                  ...
                  (=
                   ...
                   true)
                  (let
                   ((X15 Int (ite (not (= X1 1)) 1 X1)))
                   (let
                    ((X16 Int (ite X6 X10 X7)))
                    (let
                     ((X17 Bool (or X6 X3)))
                     (let
                      ((X18 Int (ite (not X13) 0 1)))
                      (let
                       ((X19
                         Bool (and
                               (and (>= X16 3) (<= X16 6))
...
(define-fun
  ...
  (let
   ...
   (let
    ((X2 Int (ite (not top.usr.onOff_a_1) 0 1)))
    (let
     ((X3
       Bool (and
             (and (>= X1 2) (<= X1 8))
           ...
           (let
            ...
            (let
             ...
             (and
              (= top.usr.OK_a_1 X11)
              (let
               ((X12 Bool (and (not top.usr.decelSet_a_0) top.usr.decelSet_a_1)))
               (let
                ((X13
                  Bool (and
                        (and
...
(define-fun
  ...
  (let
   ((X1 Int 0))
   (let
    ((X2 Int (ite (not top.usr.onOff) 0 1)))
    (let
     ((X3
       Bool (and
             (and (>= X1 2) (<= X1 8))
           ...
           (let
            ...
            (let
             ...
             (and
              (= top.usr.OK! X11)
              (let
               ((X12 Bool (and (not top.usr.decelSet) top.usr.decelSet!)))
               (let
                ((X13
                  Bool (and
                        (and
                ...
                (let
                 ((X14
                   Bool (and (not top.usr.accelResume) top.usr.accelResume!)))
                 (and
                  (=
                   top.impl.usr.cruise_controller_CruiseController_ModeLogic_DelayOnsetDecel_Bounded_Count_Out!
                   (ite
