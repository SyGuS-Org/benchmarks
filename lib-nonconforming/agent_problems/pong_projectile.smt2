...
(define-fun y_hit ((locX Real) (locY Real) (velY Real)) Real
    (+ locY (* velY (/ (- 69 locX) 2))))

    (declare-const locX0 Real)
    (declare-const locY0 Real)
    (declare-const velY0 Real)
    (declare-const locX1 Real)
    (declare-const locY1 Real)
    (declare-const velY1 Real)
    (declare-const locX2 Real)
    (declare-const locY2 Real)
    (declare-const velY2 Real)
    (declare-const locX3 Real)
    (declare-const locY3 Real)
    (declare-const velY3 Real)
    (declare-const locX4 Real)
    (declare-const locY4 Real)
    (declare-const velY4 Real)
    (declare-const locX5 Real)
    (declare-const locY5 Real)
    (declare-const velY5 Real)
    (declare-const locX6 Real)
    (declare-const locY6 Real)
    (declare-const velY6 Real)
    (declare-const locX7 Real)
    (declare-const locY7 Real)
    (declare-const velY7 Real)
    (declare-const locX8 Real)
    (declare-const locY8 Real)
    (declare-const velY8 Real)
    (declare-const locX9 Real)
    (declare-const locY9 Real)
    (declare-const velY9 Real)
    (declare-const locX10 Real)
    (declare-const locY10 Real)
    (declare-const velY10 Real)
    (declare-const locX11 Real)
    (declare-const locY11 Real)
    (declare-const velY11 Real)
    (declare-const locX12 Real)
    (declare-const locY12 Real)
    (declare-const velY12 Real)
    (declare-const locX13 Real)
    (declare-const locY13 Real)
    (declare-const velY13 Real)
    (declare-const locX14 Real)
    (declare-const locY14 Real)
    (declare-const velY14 Real)
    (declare-const locX15 Real)
    (declare-const locY15 Real)
    (declare-const velY15 Real)
    (declare-const locX16 Real)
    (declare-const locY16 Real)
    (declare-const velY16 Real)
    (declare-const locX17 Real)
    (declare-const locY17 Real)
    (declare-const velY17 Real)
    (declare-const locX18 Real)
    (declare-const locY18 Real)
    (declare-const velY18 Real)
    (declare-const locX19 Real)
    (declare-const locY19 Real)
    (declare-const velY19 Real)
    (declare-const locX20 Real)
    (declare-const locY20 Real)
    (declare-const velY20 Real)
    (declare-const locX21 Real)
    (declare-const locY21 Real)
    (declare-const velY21 Real)
    (declare-const locX22 Real)
    (declare-const locY22 Real)
    (declare-const velY22 Real)
    (declare-const locX23 Real)
    (declare-const locY23 Real)
    (declare-const velY23 Real)
    (declare-const locX24 Real)
    (declare-const locY24 Real)
    (declare-const velY24 Real)
    (declare-const locX25 Real)
    (declare-const locY25 Real)
    (declare-const velY25 Real)
    (declare-const locX26 Real)
    (declare-const locY26 Real)
    (declare-const velY26 Real)
    (declare-const locX27 Real)
    (declare-const locY27 Real)
    (declare-const velY27 Real)
    (declare-const locX28 Real)
    (declare-const locY28 Real)
    (declare-const velY28 Real)
    (declare-const locX29 Real)
    (declare-const locY29 Real)
    (declare-const velY29 Real)
    (declare-const locX30 Real)
    (declare-const locY30 Real)
    (declare-const velY30 Real)
