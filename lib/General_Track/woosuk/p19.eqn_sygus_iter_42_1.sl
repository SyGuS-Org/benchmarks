...
(define-fun origCir ((n243 Bool) (n237 Bool) (n231 Bool) (n194 Bool)) Bool
    (and n243 (and n237 (and n231 n194))))
(synth-fun skel ((n243 Bool) (n237 Bool) (n231 Bool) (n194 Bool)) Bool
    ...
    (depth7 Bool ((and depth6 depth6) (or depth6 depth6) (xor depth7 depth7) (not depth7) depth6 n231 n194))
    ...
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0 n243 n237))
...
(constraint (= (origCir n243 n237 n231 n194) (skel n243 n237 n231 n194)))
