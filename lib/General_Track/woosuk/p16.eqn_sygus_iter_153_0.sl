...
(define-fun origCir ((n207 Bool) (n254 Bool) (n325 Bool) (n221 Bool)) Bool
    (and (xor n325 (not (and n254 n207))) n221))
(synth-fun skel ((n207 Bool) (n254 Bool) (n325 Bool) (n221 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n221))))

(declare-var n207 Bool)
(declare-var n254 Bool)
(declare-var n325 Bool)
(declare-var n221 Bool)
(constraint (= (origCir n207 n254 n325 n221) (skel n207 n254 n325 n221)))
