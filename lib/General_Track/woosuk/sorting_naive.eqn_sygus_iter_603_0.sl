...
(define-fun origCir ((n364 Bool) (n379 Bool) (n308 Bool) (n215 Bool) (n455 Bool) (i_27 Bool)) Bool
    (and (and (and n455 (xor (and n308 n215) (not (and n379 n364)))) (xor (and (not (xor (and n308 n215) (not (and n379 n364)))) (and n379 n364)) (not (and n379 n364)))) i_27))
(synth-fun skel ((n364 Bool) (n379 Bool) (n308 Bool) (n215 Bool) (n455 Bool) (i_27 Bool)) Bool
...
(constraint (= (origCir n364 n379 n308 n215 n455 i_27) (skel n364 n379 n308 n215 n455 i_27)))
