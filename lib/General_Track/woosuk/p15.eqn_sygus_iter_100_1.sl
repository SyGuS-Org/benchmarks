...
(define-fun origCir ((n307 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    (and n307 (xor n261 (and n253 n170))))
(synth-fun skel ((n307 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    ...
    (depth4 Bool ((and depth3 depth3) (or depth3 depth3) (xor depth4 depth4) (not depth4) depth3 n307 n253))
...
(constraint (= (origCir n307 n261 n253 n170) (skel n307 n261 n253 n170)))
