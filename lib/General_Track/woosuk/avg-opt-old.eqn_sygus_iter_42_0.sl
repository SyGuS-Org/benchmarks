...
(define-fun origCir ((n142 Bool) (n129 Bool) (n135 Bool) (n133 Bool) (n108 Bool) (n125 Bool)) Bool
    (and n142 (and (not (and (and n135 n133) n129)) (xor n108 n125))))
(synth-fun skel ((n142 Bool) (n129 Bool) (n135 Bool) (n133 Bool) (n108 Bool) (n125 Bool)) Bool
    ...
    (depth4 Bool ((and depth3 depth3) (or depth3 depth3) (xor depth4 depth4) (not depth4) depth3 n142 n129 n133))
...
(constraint (= (origCir n142 n129 n135 n133 n108 n125) (skel n142 n129 n135 n133 n108 n125)))
