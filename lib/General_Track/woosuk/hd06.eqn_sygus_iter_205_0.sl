...
(define-fun origCir ((n105 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i34 Bool)) Bool
    (xor (and (xor n325 (not (and n254 n207))) n105) i34))
(synth-fun skel ((n105 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i34 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n105 i34))))
...
(constraint (= (origCir n105 n325 n254 n207 i34) (skel n105 n325 n254 n207 i34)))
