...
(define-fun origCir ((n376 Bool) (n379 Bool) (n371 Bool) (n373 Bool) (i_17 Bool)) Bool
    (and (and (and n379 (xor n371 n373)) n376) i_17))
(synth-fun skel ((n376 Bool) (n379 Bool) (n371 Bool) (n373 Bool) (i_17 Bool)) Bool
...
(constraint (= (origCir n376 n379 n371 n373 i_17) (skel n376 n379 n371 n373 i_17)))
