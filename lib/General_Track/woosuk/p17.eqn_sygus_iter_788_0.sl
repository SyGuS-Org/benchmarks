...
(define-fun origCir ((n160 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i42 Bool)) Bool
    (xor (and (xor n325 (not (and n254 n207))) n160) i42))
(synth-fun skel ((n160 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i42 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n160 i42))))
...
(constraint (= (origCir n160 n325 n254 n207 i42) (skel n160 n325 n254 n207 i42)))
