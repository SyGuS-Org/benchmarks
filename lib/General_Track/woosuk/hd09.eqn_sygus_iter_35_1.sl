...
(define-fun origCir ((n177 Bool) (n171 Bool) (n166 Bool)) Bool
    (not (and n177 (and n171 n166))))
(synth-fun skel ((n177 Bool) (n171 Bool) (n166 Bool)) Bool
    ...
    (depth8 Bool ((and depth7 depth7) (or depth7 depth7) (xor depth8 depth8) (not depth8) depth7 n166))
    (depth7 Bool ((and depth6 depth6) (or depth6 depth6) (xor depth7 depth7) (not depth7) depth6 n177 n171))
...
(constraint (= (origCir n177 n171 n166) (skel n177 n171 n166)))
