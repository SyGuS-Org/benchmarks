...
(define-fun origCir ((n72 Bool) (n103 Bool) (n88 Bool) (n60 Bool) (i_17 Bool)) Bool
    (and (not (xor (xor n103 (and n88 n60)) n72)) i_17))
(synth-fun skel ((n72 Bool) (n103 Bool) (n88 Bool) (n60 Bool) (i_17 Bool)) Bool
...
(constraint (= (origCir n72 n103 n88 n60 i_17) (skel n72 n103 n88 n60 i_17)))
