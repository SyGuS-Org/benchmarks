...
(define-fun origCir ((n284 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    (and n284 (xor n261 (and n253 n170))))
(synth-fun skel ((n284 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    ...
    (depth3 Bool ((and depth2 depth2) (or depth2 depth2) (xor depth3 depth3) (not depth3) depth2 n284))
...
(constraint (= (origCir n284 n261 n253 n170) (skel n284 n261 n253 n170)))
