...
(define-fun origCir ((n261 Bool) (n132 Bool) (n152 Bool) (n176 Bool) (i_23 Bool)) Bool
    (and n261 (not (xor (and (not (xor n176 n152)) n132) (and (xor n176 n152) i_23)))))
(synth-fun skel ((n261 Bool) (n132 Bool) (n152 Bool) (n176 Bool) (i_23 Bool)) Bool
    ...
    (depth5 Bool ((and depth4 depth4) (or depth4 depth4) (xor depth5 depth5) (not depth5) depth4 n261 n132))
...
(constraint (= (origCir n261 n132 n152 n176 i_23) (skel n261 n132 n152 n176 i_23)))
