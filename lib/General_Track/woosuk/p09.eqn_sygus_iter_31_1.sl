...
(define-fun origCir ((n202 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    (and n202 (and n174 (and n114 n87))))
(synth-fun skel ((n202 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    ...
    (depth2 Bool ((and depth1 depth1) (or depth1 depth1) (xor depth2 depth2) (not depth2) depth1 n202 n114))
...
(constraint (= (origCir n202 n174 n114 n87) (skel n202 n174 n114 n87)))
