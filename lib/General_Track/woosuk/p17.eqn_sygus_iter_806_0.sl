...
(define-fun origCir ((n167 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i41 Bool)) Bool
    (xor (and (xor n325 (not (and n254 n207))) n167) i41))
(synth-fun skel ((n167 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i41 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n167 i41))))
...
(constraint (= (origCir n167 n325 n254 n207 i41) (skel n167 n325 n254 n207 i41)))
