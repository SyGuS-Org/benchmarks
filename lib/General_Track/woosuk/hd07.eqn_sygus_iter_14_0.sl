...
(define-fun origCir ((n200 Bool) (n215 Bool) (n209 Bool) (i22 Bool)) Bool
    (and (not (and (and n215 n209) n200)) i22))
(synth-fun skel ((n200 Bool) (n215 Bool) (n209 Bool) (i22 Bool)) Bool
    ...
    (depth6 Bool ((and depth5 depth5) (or depth5 depth5) (xor depth6 depth6) (not depth6) depth5 n209))
    ...
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0 n215))
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) i22))))

(declare-var n200 Bool)
(declare-var n215 Bool)
(declare-var n209 Bool)
(declare-var i22 Bool)
(constraint (= (origCir n200 n215 n209 i22) (skel n200 n215 n209 i22)))
