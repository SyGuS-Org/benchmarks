...
(define-fun origCir ((n71 Bool) (n102 Bool) (n87 Bool) (n59 Bool) (i_7 Bool)) Bool
    (and (xor (xor n102 (and n87 n59)) n71) i_7))
(synth-fun skel ((n71 Bool) (n102 Bool) (n87 Bool) (n59 Bool) (i_7 Bool)) Bool
...
(constraint (= (origCir n71 n102 n87 n59 i_7) (skel n71 n102 n87 n59 i_7)))
