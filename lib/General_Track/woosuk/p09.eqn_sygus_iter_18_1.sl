...
(define-fun origCir ((n194 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    (and n194 (and n174 (and n114 n87))))
(synth-fun skel ((n194 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    ...
    (depth2 Bool ((and depth1 depth1) (or depth1 depth1) (xor depth2 depth2) (not depth2) depth1 n194 n114))
...
(constraint (= (origCir n194 n174 n114 n87) (skel n194 n174 n114 n87)))
