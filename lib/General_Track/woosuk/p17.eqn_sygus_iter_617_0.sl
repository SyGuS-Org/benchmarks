...
(define-fun origCir ((n127 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i37 Bool)) Bool
    (xor (and (xor n325 (not (and n254 n207))) n127) i37))
(synth-fun skel ((n127 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i37 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n127 i37))))
...
(constraint (= (origCir n127 n325 n254 n207 i37) (skel n127 n325 n254 n207 i37)))
