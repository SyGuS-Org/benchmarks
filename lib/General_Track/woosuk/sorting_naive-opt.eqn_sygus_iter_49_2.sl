...
(define-fun origCir ((n322 Bool) (n325 Bool) (n315 Bool) (n319 Bool) (i_18 Bool)) Bool
    (and (and (and n325 (not (xor n315 n319))) n322) i_18))
(synth-fun skel ((n322 Bool) (n325 Bool) (n315 Bool) (n319 Bool) (i_18 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n322 i_18))))
...
(constraint (= (origCir n322 n325 n315 n319 i_18) (skel n322 n325 n315 n319 i_18)))
