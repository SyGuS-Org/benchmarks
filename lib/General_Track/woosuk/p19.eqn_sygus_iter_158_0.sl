...
(define-fun origCir ((n238 Bool) (n255 Bool) (i27 Bool)) Bool
    (and (not (and n255 n238)) i27))
(synth-fun skel ((n238 Bool) (n255 Bool) (i27 Bool)) Bool
    ...
    (depth8 Bool ((and depth7 depth7) (or depth7 depth7) (xor depth8 depth8) (not depth8) depth7 n238))
    (depth7 Bool ((and depth6 depth6) (or depth6 depth6) (xor depth7 depth7) (not depth7) depth6 n255))
...
(declare-var n238 Bool)
(declare-var n255 Bool)
(declare-var i27 Bool)
(constraint (= (origCir n238 n255 i27) (skel n238 n255 i27)))
