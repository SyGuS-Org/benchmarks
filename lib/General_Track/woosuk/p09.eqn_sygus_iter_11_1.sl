...
(define-fun origCir ((n187 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    (and n187 (and n174 (and n114 n87))))
(synth-fun skel ((n187 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
...
(constraint (= (origCir n187 n174 n114 n87) (skel n187 n174 n114 n87)))
