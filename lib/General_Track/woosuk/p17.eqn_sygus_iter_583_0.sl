...
(define-fun origCir ((n125 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i36 Bool)) Bool
    (xor (and (xor n325 (not (and n254 n207))) n125) i36))
(synth-fun skel ((n125 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i36 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n125 i36))))
...
(constraint (= (origCir n125 n325 n254 n207 i36) (skel n125 n325 n254 n207 i36)))
