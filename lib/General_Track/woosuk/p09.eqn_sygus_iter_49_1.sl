...
(define-fun origCir ((n225 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    (and n225 (and n174 (and n114 n87))))
(synth-fun skel ((n225 Bool) (n174 Bool) (n114 Bool) (n87 Bool)) Bool
    ...
    (depth3 Bool ((and depth2 depth2) (or depth2 depth2) (xor depth3 depth3) (not depth3) depth2 n225 n174 n87))
...
(constraint (= (origCir n225 n174 n114 n87) (skel n225 n174 n114 n87)))
