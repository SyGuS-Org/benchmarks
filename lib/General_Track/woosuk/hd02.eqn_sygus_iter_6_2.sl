...
(define-fun origCir ((n180 Bool) (n142 Bool) (n173 Bool) (n114 Bool) (n86 Bool) (n74 Bool)) Bool
    (and n180 (and (and n173 n142) (and n114 (and n86 n74)))))
(synth-fun skel ((n180 Bool) (n142 Bool) (n173 Bool) (n114 Bool) (n86 Bool) (n74 Bool)) Bool
    ...
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0 n86))
...
(constraint (= (origCir n180 n142 n173 n114 n86 n74) (skel n180 n142 n173 n114 n86 n74)))
