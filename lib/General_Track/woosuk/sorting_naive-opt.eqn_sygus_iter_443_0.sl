...
(define-fun origCir ((n376 Bool) (i_17 Bool) (n373 Bool) (n371 Bool) (n379 Bool)) Bool
    (not (and (and (xor n373 n371) (and i_17 n376)) n379)))
(synth-fun skel ((n376 Bool) (i_17 Bool) (n373 Bool) (n371 Bool) (n379 Bool)) Bool
...
(constraint (= (origCir n376 i_17 n373 n371 n379) (skel n376 i_17 n373 n371 n379)))
