...
(define-fun origCir ((n265 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    (and n265 (xor n261 (and n253 n170))))
(synth-fun skel ((n265 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    ...
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0 n265))
...
(constraint (= (origCir n265 n261 n253 n170) (skel n265 n261 n253 n170)))
