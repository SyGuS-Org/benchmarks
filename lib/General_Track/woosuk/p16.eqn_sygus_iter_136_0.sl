...
(define-fun origCir ((n207 Bool) (n254 Bool) (n325 Bool) (n107 Bool)) Bool
    (and (xor n325 (not (and n254 n207))) n107))
(synth-fun skel ((n207 Bool) (n254 Bool) (n325 Bool) (n107 Bool)) Bool
...
(constraint (= (origCir n207 n254 n325 n107) (skel n207 n254 n325 n107)))
