...
(define-fun origCir ((n165 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i40 Bool)) Bool
    (xor (and (xor n325 (not (and n254 n207))) n165) i40))
(synth-fun skel ((n165 Bool) (n325 Bool) (n254 Bool) (n207 Bool) (i40 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n165 i40))))
...
(constraint (= (origCir n165 n325 n254 n207 i40) (skel n165 n325 n254 n207 i40)))
