...
(define-fun origCir ((n80 Bool) (i_10 Bool) (n45 Bool) (n48 Bool) (i_2 Bool) (n53 Bool)) Bool
    (and n80 (and (not (xor (xor (xor n48 n45) i_2) i_10)) n53)))
(synth-fun skel ((n80 Bool) (i_10 Bool) (n45 Bool) (n48 Bool) (i_2 Bool) (n53 Bool)) Bool
    ...
    (depth6 Bool ((and depth5 depth5) (or depth5 depth5) (xor depth6 depth6) (not depth6) depth5 n80 n45 n53))
...
(constraint (= (origCir n80 i_10 n45 n48 i_2 n53) (skel n80 i_10 n45 n48 i_2 n53)))
