...
(define-fun origCir ((n277 Bool) (n271 Bool) (n231 Bool) (n194 Bool)) Bool
    (and n277 (and n271 (and n231 n194))))
(synth-fun skel ((n277 Bool) (n271 Bool) (n231 Bool) (n194 Bool)) Bool
    ...
    (depth7 Bool ((and depth6 depth6) (or depth6 depth6) (xor depth7 depth7) (not depth7) depth6 n271 n231 n194))
...
(constraint (= (origCir n277 n271 n231 n194) (skel n277 n271 n231 n194)))
