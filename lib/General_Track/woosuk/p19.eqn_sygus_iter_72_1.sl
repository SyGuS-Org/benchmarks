...
(synth-fun skel ((n237 Bool) (n231 Bool) (n193 Bool) (n153 Bool)) Bool
    ...
    (depth6 Bool ((and depth5 depth5) (or depth5 depth5) (xor depth6 depth6) (not depth6) depth5 n231 n153))
    (depth5 Bool ((and depth4 depth4) (or depth4 depth4) (xor depth5 depth5) (not depth5) depth4 n193))
