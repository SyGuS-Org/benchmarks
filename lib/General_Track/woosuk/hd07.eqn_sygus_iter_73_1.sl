...
(define-fun origCir ((n232 Bool) (n237 Bool) (n261 Bool) (n255 Bool) (i28 Bool)) Bool
    (and (not (and (and n261 n255) (and n237 n232))) i28))
(synth-fun skel ((n232 Bool) (n237 Bool) (n261 Bool) (n255 Bool) (i28 Bool)) Bool
    ...
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0 n237 n261))
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) i28))))

(declare-var n232 Bool)
(declare-var n237 Bool)
(declare-var n261 Bool)
(declare-var n255 Bool)
(declare-var i28 Bool)
(constraint (= (origCir n232 n237 n261 n255 i28) (skel n232 n237 n261 n255 i28)))
