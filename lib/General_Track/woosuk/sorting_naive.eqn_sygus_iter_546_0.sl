...
(define-fun origCir ((n119 Bool) (n310 Bool) (n313 Bool) (n269 Bool) (n445 Bool) (i_11 Bool)) Bool
    (and (and (and n445 (xor (and n313 n269) (not (and n310 n119)))) (xor (and (not (xor (and n313 n269) (not (and n310 n119)))) (and n310 n119)) (not (and n310 n119)))) i_11))
(synth-fun skel ((n119 Bool) (n310 Bool) (n313 Bool) (n269 Bool) (n445 Bool) (i_11 Bool)) Bool
    ...
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) i_11))))
...
(declare-var i_11 Bool)
(constraint (= (origCir n119 n310 n313 n269 n445 i_11) (skel n119 n310 n313 n269 n445 i_11)))
