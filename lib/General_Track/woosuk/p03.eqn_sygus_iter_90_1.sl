...
(define-fun origCir ((n160 Bool) (n152 Bool) (n121 Bool) (n90 Bool)) Bool
    (and n160 (and n152 (and n121 n90))))
(synth-fun skel ((n160 Bool) (n152 Bool) (n121 Bool) (n90 Bool)) Bool
    ...
    (depth2 Bool ((and depth1 depth1) (or depth1 depth1) (xor depth2 depth2) (not depth2) depth1 n160))
...
(constraint (= (origCir n160 n152 n121 n90) (skel n160 n152 n121 n90)))
