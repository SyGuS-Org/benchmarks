...
(define-fun origCir ((n295 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    (and n295 (xor n261 (and n253 n170))))
(synth-fun skel ((n295 Bool) (n261 Bool) (n253 Bool) (n170 Bool)) Bool
    ...
    (depth3 Bool ((and depth2 depth2) (or depth2 depth2) (xor depth3 depth3) (not depth3) depth2 n295))
    (depth2 Bool ((and depth1 depth1) (or depth1 depth1) (xor depth2 depth2) (not depth2) depth1))
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0))
    (depth0 Bool (true false (xor depth0 depth0) (not depth0)))))

(declare-var n295 Bool)
(declare-var n261 Bool)
(declare-var n253 Bool)
(declare-var n170 Bool)
(constraint (= (origCir n295 n261 n253 n170) (skel n295 n261 n253 n170)))
