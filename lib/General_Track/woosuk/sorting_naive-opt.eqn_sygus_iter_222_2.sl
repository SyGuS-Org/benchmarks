...
(define-fun origCir ((n386 Bool) (n389 Bool) (n393 Bool) (n388 Bool) (i_8 Bool)) Bool
    (and (and (and n393 (not n388)) (xor n389 n386)) i_8))
(synth-fun skel ((n386 Bool) (n389 Bool) (n393 Bool) (n388 Bool) (i_8 Bool)) Bool
...
(constraint (= (origCir n386 n389 n393 n388 i_8) (skel n386 n389 n393 n388 i_8)))
