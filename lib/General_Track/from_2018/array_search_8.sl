...
(synth-fun findIdx ((y1 Int) (y2 Int) (y3 Int) (y4 Int) (y5 Int) (y6 Int) (y7 Int) (y8 Int) (k1 Int)) Int
    ((Start Int) (BoolExpr Bool))
    ((Start Int (0 1 2 3 4 5 6 7 8 y1 y2 y3 y4 y5 y6 y7 y8 k1 (ite BoolExpr Start Start)))
