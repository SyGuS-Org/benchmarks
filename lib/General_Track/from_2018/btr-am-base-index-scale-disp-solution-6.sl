...
(synth-fun btr-am ((base (_ BitVec 32)) (index (_ BitVec 32)) (scale (_ BitVec 32)) (disp (_ BitVec 32)) (mem (_ BitVec 32)) (bit (_ BitVec 32))) (_ BitVec 32)
    ...
    (Is (_ BitVec 32) ((Constant (_ BitVec 32)) (Variable (_ BitVec 32)) (bvadd Is Is) (bvshl Is Is) (bvsub Is Is) (bvor Is Is) (bvshl Is Is) (load-val base index scale disp Is Start)))))
