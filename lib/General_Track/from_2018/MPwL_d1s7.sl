...
(constraint (let ((pos0 0)) (let ((mov0 (move pos0 99 98))) (let ((pos1 (interpret-move pos0 mov0))) (let ((mov1 (move pos1 o0-1 o1-1))) (let ((pos2 (interpret-move pos1 mov1))) (let ((mov2 (move pos2 o0-2 o1-2))) (let ((pos3 (interpret-move pos2 mov2))) (let ((mov3 (move pos3 o0-3 o1-3))) (let ((pos4 (interpret-move pos3 mov3))) (let ((mov4 (move pos4 o0-4 o1-4))) (let ((pos5 (interpret-move pos4 mov4))) (let ((mov5 (move pos5 o0-5 o1-5))) (let ((pos6 (interpret-move pos5 mov5))) (let ((mov6 (move pos6 o0-6 o1-6))) (let ((pos7 (interpret-move pos6 mov6))) (or (and (= pos7 70) (and (no-overlaps-one-step pos0 mov0 99 o0-1 98 o1-1) (and (no-overlaps-one-step pos1 mov1 o0-1 o0-2 o1-1 o1-2) (and (no-overlaps-one-step pos2 mov2 o0-2 o0-3 o1-2 o1-3) (and (no-overlaps-one-step pos3 mov3 o0-3 o0-4 o1-3 o1-4) (and (no-overlaps-one-step pos4 mov4 o0-4 o0-5 o1-4 o1-5) (and (no-overlaps-one-step pos5 mov5 o0-5 o0-6 o1-5 o1-6) (and (no-overlaps-one-step pos6 mov6 o0-6 o0-7 o1-6 o1-7) true)))))))) (not (and (allowable-move-obstacle-0 99 o0-1) (and (allowable-move-obstacle-0 o0-1 o0-2) (and (allowable-move-obstacle-0 o0-2 o0-3) (and (allowable-move-obstacle-0 o0-3 o0-4) (and (allowable-move-obstacle-0 o0-4 o0-5) (and (allowable-move-obstacle-0 o0-5 o0-6) (and (allowable-move-obstacle-0 o0-6 o0-7) (and (allowable-move-obstacle-1 98 o1-1) (and (allowable-move-obstacle-1 o1-1 o1-2) (and (allowable-move-obstacle-1 o1-2 o1-3) (and (allowable-move-obstacle-1 o1-3 o1-4) (and (allowable-move-obstacle-1 o1-4 o1-5) (and (allowable-move-obstacle-1 o1-5 o1-6) (and (allowable-move-obstacle-1 o1-6 o1-7) true))))))))))))))))))))))))))))))))
