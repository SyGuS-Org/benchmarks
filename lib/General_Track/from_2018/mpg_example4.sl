...
(synth-fun eq2 ((x Int) (y Int) (z Int) (z1 Int)) Int
    ...
    ((Start Int (x y z z1 0 1 (+ Start Start) (- Start Start) (ite StartBool Start Start)))
...
(define-fun plus8 ((b1 Int) (b2 Int) (b3 Int) (b4 Int) (b5 Int) (b6 Int) (b7 Int) (b8 Int)) Int
    (+ (plus7 b1 b2 b3 b4 b5 b6 b7) b8))
...
(define-fun eleven-times ((b1 Int)) Int
    (plus8 b1 b1 b1 b1 b1 b1 (plus3 b1 b1 b1) (plus2 b1 b1)))
...
(declare-var z Int)
(declare-var z1 Int)
(constraint (iteB (>= (plus3 (two-times x) z (minus z1)) (minus y)) (iteB (<= (plus2 x z1) y) (= (eq2 x y z z1) (plus4 (ten-times x) (two-times (ten-times y)) (three-times (five-times z)) (- 99))) (= (eq2 x y z z1) (plus3 (nine-times y) (five-times (five-times z1)) (- 11)))) (iteB (<= (plus3 x (three-times z) z1) (- 9)) (= (eq2 x y z z1) (plus5 (eleven-times x) (five-times (three-times y)) (three-times (ten-times z)) (two-times (eleven-times z1)) 11)) (= (eq2 x y z z1) (plus4 (four-times (four-times x)) (three-times (six-times z)) (five-times z1) (- 55))))))
