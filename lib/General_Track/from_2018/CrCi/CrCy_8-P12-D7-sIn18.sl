...
(synth-fun skel ((LN179 Bool) (k8 Bool) (LN343 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN343))
    ...
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN179))
    (depth6 Bool (k8))))
