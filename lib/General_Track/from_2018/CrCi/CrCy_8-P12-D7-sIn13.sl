...
(synth-fun skel ((LN84 Bool) (LN122 Bool) (k7 Bool) (LN131 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN122))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN84 LN131))
    (depth6 Bool (k7))))
