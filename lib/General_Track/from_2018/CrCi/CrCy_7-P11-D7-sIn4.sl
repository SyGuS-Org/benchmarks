...
(synth-fun skel ((LN1 Bool) (LN39 Bool) (k7 Bool) (LN48 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN39))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN1 LN48))
    (depth6 Bool (k7))))
