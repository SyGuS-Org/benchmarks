...
(define-fun origCir ((LN85 Bool) (LN86 Bool)) Bool
    (xor LN86 LN85))
(synth-fun skel ((LN85 Bool) (LN86 Bool)) Bool
    ...
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN85))
    (depth4 Bool (LN86))))

(declare-var LN85 Bool)
(declare-var LN86 Bool)
(constraint (= (origCir LN85 LN86) (skel LN85 LN86)))
