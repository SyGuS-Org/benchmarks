...
(define-fun origCir ((LN218 Bool) (LN231 Bool) (LN240 Bool) (LN252 Bool)) Bool
    (not (and LN252 (xor (xor LN231 LN240) LN218))))
(synth-fun skel ((LN218 Bool) (LN231 Bool) (LN240 Bool) (LN252 Bool)) Bool
...
(constraint (= (origCir LN218 LN231 LN240 LN252) (skel LN218 LN231 LN240 LN252)))
