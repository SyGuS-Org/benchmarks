...
(synth-fun skel ((LN1 Bool) (LN33 Bool) (LN213 Bool) (LN221 Bool)) Bool
    ...
    (depth1 Bool ((and depth2 depth2) (not depth2) (or depth2 depth2) (xor depth2 depth2) LN213))
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN221))
