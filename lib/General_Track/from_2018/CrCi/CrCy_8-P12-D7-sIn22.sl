...
(synth-fun skel ((LN135 Bool) (LN142 Bool) (LN326 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN326))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN135))
    (depth6 Bool (LN142))))
