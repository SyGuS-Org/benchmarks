...
(define-fun origCir ((LN8 Bool) (k4 Bool) (LN75 Bool) (LN222 Bool) (LN226 Bool)) Bool
    (not (not (not (not (xor LN226 (xor (xor LN75 (and LN8 k4)) LN222)))))))
(synth-fun skel ((LN8 Bool) (k4 Bool) (LN75 Bool) (LN222 Bool) (LN226 Bool)) Bool
    ...
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN226))
    (depth6 Bool ((and depth7 depth7) (not depth7) (or depth7 depth7) (xor depth7 depth7) LN222))
    (depth7 Bool ((and depth8 depth8) (not depth8) (or depth8 depth8) (xor depth8 depth8) LN8 LN75))
    (depth8 Bool (k4))))
