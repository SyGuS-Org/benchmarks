...
(synth-fun skel ((LN8 Bool) (k4 Bool) (LN17 Bool) (LN252 Bool) (LN257 Bool)) Bool
    ...
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN257))
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN252))
