...
(synth-fun skel ((LN196 Bool) (LN213 Bool) (LN222 Bool) (LN259 Bool) (LN318 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN318))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN222))
