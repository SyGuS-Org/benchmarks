...
(synth-fun skel ((LN10 Bool) (LN33 Bool) (LN49 Bool) (LN234 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN234))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN33 LN49))
    (depth4 Bool (LN10))))
