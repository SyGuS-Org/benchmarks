...
(synth-fun skel ((LN198 Bool) (LN205 Bool) (LN367 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN367))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN198))
    (depth6 Bool (LN205))))
