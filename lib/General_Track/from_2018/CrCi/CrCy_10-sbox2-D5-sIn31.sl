...
(synth-fun skel ((LN7 Bool) (LN34 Bool) (LN56 Bool) (LN178 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN178))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN34 LN56))
    (depth4 Bool (LN7))))
