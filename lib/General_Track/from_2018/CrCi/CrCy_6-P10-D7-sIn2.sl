...
(define-fun origCir ((LN8 Bool) (k4 Bool) (LN75 Bool) (LN88 Bool) (LN92 Bool)) Bool
    (not (not (xor LN92 (xor (xor LN75 (and LN8 k4)) LN88)))))
(synth-fun skel ((LN8 Bool) (k4 Bool) (LN75 Bool) (LN88 Bool) (LN92 Bool)) Bool
    ...
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN92))
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN88))
