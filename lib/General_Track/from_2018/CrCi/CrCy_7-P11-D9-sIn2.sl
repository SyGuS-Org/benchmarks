...
(synth-fun skel ((LN4 Bool) (LN25 Bool) (k7 Bool) (LN68 Bool) (LN72 Bool)) Bool
    ...
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN72))
    (depth6 Bool ((and depth7 depth7) (not depth7) (or depth7 depth7) (xor depth7 depth7) LN68))
    (depth7 Bool ((and depth8 depth8) (not depth8) (or depth8 depth8) (xor depth8 depth8) LN4 LN25))
    (depth8 Bool (k7))))
