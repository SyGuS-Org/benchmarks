...
(synth-fun skel ((LN8 Bool) (k4 Bool) (LN17 Bool) (LN126 Bool) (LN131 Bool)) Bool
    ...
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN131))
    (depth6 Bool ((and depth7 depth7) (not depth7) (or depth7 depth7) (xor depth7 depth7) LN126))
    (depth7 Bool ((and depth8 depth8) (not depth8) (or depth8 depth8) (xor depth8 depth8) LN8 LN17))
    (depth8 Bool (k4))))
