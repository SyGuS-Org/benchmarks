...
(synth-fun skel ((LN33 Bool) (k8 Bool) (LN82 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN82))
    ...
    (depth7 Bool ((and depth8 depth8) (not depth8) (or depth8 depth8) (xor depth8 depth8) LN33))
    (depth8 Bool (k8))))
