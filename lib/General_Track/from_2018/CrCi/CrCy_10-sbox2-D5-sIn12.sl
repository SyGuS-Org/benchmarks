...
(synth-fun skel ((LN1 Bool) (LN39 Bool) (LN56 Bool) (LN65 Bool) (LN166 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN65 LN166))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN39 LN56))
    (depth4 Bool (LN1))))
