...
(synth-fun skel ((LN4 Bool) (LN25 Bool) (k7 Bool) (LN68 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN68))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN4 LN25))
    (depth4 Bool (k7))))
