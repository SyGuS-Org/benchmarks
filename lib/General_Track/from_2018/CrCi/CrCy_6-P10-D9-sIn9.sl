...
(synth-fun skel ((LN43 Bool) (LN47 Bool) (k4 Bool) (LN155 Bool) (LN158 Bool)) Bool
    ...
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN158))
    (depth6 Bool ((and depth7 depth7) (not depth7) (or depth7 depth7) (xor depth7 depth7) LN155))
    (depth7 Bool ((and depth8 depth8) (not depth8) (or depth8 depth8) (xor depth8 depth8) LN43 LN47))
    (depth8 Bool (k4))))
