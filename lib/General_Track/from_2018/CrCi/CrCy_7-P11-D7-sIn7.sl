...
(synth-fun skel ((LN52 Bool) (LN59 Bool) (LN104 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN104))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN52))
    (depth6 Bool (LN59))))
