...
(synth-fun skel ((LN7 Bool) (LN34 Bool) (LN213 Bool) (LN214 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN214))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN34))
    (depth4 Bool (LN7))))
