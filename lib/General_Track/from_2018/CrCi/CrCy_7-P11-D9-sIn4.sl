...
(synth-fun skel ((LN1 Bool) (LN39 Bool) (k7 Bool) (LN48 Bool)) Bool
    ...
    (depth6 Bool ((and depth7 depth7) (not depth7) (or depth7 depth7) (xor depth7 depth7) LN39))
    (depth7 Bool ((and depth8 depth8) (not depth8) (or depth8 depth8) (xor depth8 depth8) LN1 LN48))
    (depth8 Bool (k7))))
