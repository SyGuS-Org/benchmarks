...
(synth-fun skel ((LN52 Bool) (LN59 Bool) (LN92 Bool)) Bool
    ...
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN92))
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN52))
    (depth4 Bool (LN59))))
