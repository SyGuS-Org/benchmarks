...
(synth-fun skel ((LN87 Bool) (LN108 Bool) (k7 Bool) (LN290 Bool) (LN294 Bool)) Bool
    ...
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN294))
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN290))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN87 LN108))
    (depth6 Bool (k7))))
