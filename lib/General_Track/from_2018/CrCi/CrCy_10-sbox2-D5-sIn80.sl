...
(define-fun origCir ((LN70 Bool) (LN73 Bool) (LN236 Bool) (LN252 Bool) (LN253 Bool)) Bool
    (xor LN73 (and (xor (xor LN253 LN252) LN236) LN70)))
(synth-fun skel ((LN70 Bool) (LN73 Bool) (LN236 Bool) (LN252 Bool) (LN253 Bool)) Bool
    ...
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN70 LN73 LN236 LN252))
    (depth4 Bool (LN253))))
...
(constraint (= (origCir LN70 LN73 LN236 LN252 LN253) (skel LN70 LN73 LN236 LN252 LN253)))
