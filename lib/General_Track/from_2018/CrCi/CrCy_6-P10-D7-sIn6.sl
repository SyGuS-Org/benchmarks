...
(synth-fun skel ((LN8 Bool) (k4 Bool) (LN17 Bool) (LN118 Bool) (LN123 Bool)) Bool
    ...
    (depth3 Bool ((and depth4 depth4) (not depth4) (or depth4 depth4) (xor depth4 depth4) LN123))
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN118))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN8 LN17))
    (depth6 Bool (k4))))
