...
(synth-fun skel ((LN7 Bool) (LN34 Bool) (LN250 Bool) (LN253 Bool)) Bool
    ...
    (depth1 Bool ((and depth2 depth2) (not depth2) (or depth2 depth2) (xor depth2 depth2) LN253))
    (depth2 Bool ((and depth3 depth3) (not depth3) (or depth3 depth3) (xor depth3 depth3) LN250))
