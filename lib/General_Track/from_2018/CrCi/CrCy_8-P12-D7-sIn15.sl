...
(synth-fun skel ((LN84 Bool) (LN134 Bool) (k8 Bool)) Bool
    ...
    (depth4 Bool ((and depth5 depth5) (not depth5) (or depth5 depth5) (xor depth5 depth5) LN134))
    (depth5 Bool ((and depth6 depth6) (not depth6) (or depth6 depth6) (xor depth6 depth6) LN84))
    (depth6 Bool (k8))))
