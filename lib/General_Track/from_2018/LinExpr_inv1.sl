...
(constraint (implies (and5 (= i (inv x y)) (>= x y) (= x1 (+ x 1)) (= i1 (+ i 1)) (= i2 (+ i1 1))) (= i2 (inv x1 y))))
(constraint (implies (and5 (= i (inv x y)) (>= x y) (= y1 (+ y 1)) (= i1 (+ i 1)) (or (and (< x y1) (= i3 (+ i1 1))) (and (>= x y1) (= i3 i1)))) (= i3 (inv x y1))))
(constraint (implies (and4 (= i (inv x y)) (< x y) (= x1 (+ x 1)) (= i1 (+ i 1))) (= i1 (inv x1 y))))
(constraint (implies (and5 (= i (inv x y)) (< x y) (= y1 (+ y 1)) (= i1 (+ i 1)) (= i2 (+ i1 1))) (= i2 (inv x y1))))
