  ...
  (and
   (=
    ...
    (ite
     ...
     (and AtLeastOnceSince.usr.X_a_1 AtLeastOnceSince.usr.XsinceY_a_0)))
...
(define-fun
  ...
  (and
   (=
    Edge.usr.Y_a_1
    (and
     (and (and Edge.usr.X_a_1 (not Edge.usr.X_a_0)) (not Edge.usr.X_a_1))
     Edge.usr.X_a_0))
...
(define-fun
  ...
  (and
   (=
    ...
    (ite
     top.res.abs_2_a_0
     (or (or top.res.abs_3_a_0 top.res.abs_4_a_0) top.res.abs_5_a_0)
     true))
   (= top.impl.usr.cca_a_0 top.res.abs_1_a_0)
   (__node_init_PosEdge_0
   ...
   (__node_init_main_0
    ...
    top.res.inst_4_a_0
    top.res.inst_3_a_0)
   (__node_init_PosEdge_0 top.usr.ccseti_a_0 top.res.abs_3_a_0 top.res.inst_2_a_0)
   (__node_init_PosEdge_0 top.usr.ccsetd_a_0 top.res.abs_4_a_0 top.res.inst_1_a_0)
   (__node_init_PosEdge_0 top.usr.ccr_a_0 top.res.abs_5_a_0 top.res.inst_0_a_0)
...
(define-fun
  ...
  (and
   (= top.impl.usr.cca_a_1 top.res.abs_1_a_1)
   (=
    top.usr.OK_a_1
    (ite
     top.res.abs_2_a_1
     (or (or top.res.abs_3_a_1 top.res.abs_4_a_1) top.res.abs_5_a_1)
     true))
   (__node_trans_PosEdge_0
...
(define-fun
  ...
  (and
   (=
    ...
    (ite
     top.res.abs_2
     (or (or top.res.abs_3 top.res.abs_4) top.res.abs_5)
     true))
   (= top.impl.usr.cca top.res.abs_1)
   (__node_init_PosEdge_0 top.impl.usr.cca top.res.abs_2 top.res.inst_28)
   (__node_init_main_0
    top.usr.igsw
    top.usr.ccd
    top.usr.cconoff
    ...
    top.res.inst_4
    top.res.inst_3)
   (__node_init_PosEdge_0 top.usr.ccseti top.res.abs_3 top.res.inst_2)
   (__node_init_PosEdge_0 top.usr.ccsetd top.res.abs_4 top.res.inst_1)
   (__node_init_PosEdge_0 top.usr.ccr top.res.abs_5 top.res.inst_0)
   top.res.init_flag)
)
