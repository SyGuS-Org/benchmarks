         ...
         (and
          ...
          (let
           ...
           (let
            ...
            (let
             ((X9 (ite X8 (ite (and (>= X1 2) (<= X1 8)) 0 X1) X1)))
             (let
              ((X10 (ite X8 (ite (not (= X9 1)) 1 X9) X9)))
              (let
               ((X11
                 (and
                       (= X10 1)
               ...
               (let
                ((X12 (ite X11 (ite (= X10 1) 0 X10) X10)))
                (let
                 ((X13 (ite (not (and (>= X12 2) (<= X12 8))) 2 X12)))
                 (let
                  ((X14
                    (and
                          (not (and (>= X12 2) (<= X12 8)))
                          (and (>= X13 2) (<= X13 8)))))
                  (let
                   ((X15 (ite X14 (ite (not (= X13 7)) 7 X13) X13)))
                   (let
                    ((X16 (ite X11 X15 X12)))
                    (let
                     ((X17 (or X11 X8)))
   ...
   (let
    ...
    (let
     ...
     (and
      (= top.usr.OK_a_1 X3)
      (let
       ((X4 (and (not top.usr.decelSet_a_0) top.usr.decelSet_a_1)))
       (let
        ((X5
          (and
                (and
        ...
        (let
         ((X6 (and (not top.usr.accelResume_a_0) top.usr.accelResume_a_1)))
         (and
          (=
   ...
   (let
    ...
    (let
     ...
     (and
      (= top.usr.OK! X3)
      (let
       ((X4 (and (not top.usr.decelSet) top.usr.decelSet!)))
       (let
        ((X5
          (and
                (and
                ...
                top.usr.validInputs!)))
        (let
         ((X6 (and (not top.usr.accelResume) top.usr.accelResume!)))
         (and
          (=
           top.impl.usr.cruise_controller_CruiseController_ModeLogic_DelayOnsetDecel_Bounded_Count_Out!
           (ite
