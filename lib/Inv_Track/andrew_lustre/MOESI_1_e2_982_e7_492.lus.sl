...
(define-fun
  ...
  (and
   (= top.res.abs_7_a_0 (and top.res.abs_6_a_0 (> top.usr.init_invalid_mo_a_0 0)))
   (let
...
(define-fun
  ...
  (and
   (= top.res.abs_7_a_1 (and top.res.abs_6_a_1 (> top.usr.init_invalid_mo_a_1 0)))
   (let
...
(define-fun
  ...
  (and
   (= top.res.abs_7 (and top.res.abs_6 (> top.usr.init_invalid_mo 0)))
   (let
