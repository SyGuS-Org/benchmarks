     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (and
         (= top.usr.OK_a_0 (=> X1 (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_7_a_0)))
         (__node_init_firefly_0
          top.usr.e1_a_0
          top.usr.e2_a_0
          top.usr.e3_a_0
     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (and
         (= top.usr.OK_a_1 (=> X1 (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_7_a_1)))
         (__node_trans_firefly_0
          top.usr.e1_a_1
          top.usr.e2_a_1
          top.usr.e3_a_1
     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (and
         (= top.usr.OK (=> X1 (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_7)))
         (__node_init_firefly_0
          top.usr.e1
          top.usr.e2
          top.usr.e3
         ...
         (__node_init_excludes8_0
          ...
          top.res.abs_4
          top.res.inst_1)
         (__node_init_First_0 top.usr.i_invalid top.res.abs_7 top.res.inst_0)
         top.res.init_flag)))))))
)
