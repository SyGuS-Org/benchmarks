     ...
     (let
      ...
      (let
       ...
       (and
        ...
        (let
         ((X5 Bool top.res.abs_6_a_0))
         (and
          (= top.res.abs_7_a_0 (+ (+ (+ X1 X2) X3) X4))
          (__node_init_firefly_0
           top.usr.e1_a_0
           top.usr.e2_a_0
           top.usr.e3_a_0
     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (and
         (= top.usr.OK_a_1 (=> X1 (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_7_a_0)))
         (= top.res.abs_7_a_1 (+ (+ (+ X5 X4) X3) X2))
         (__node_trans_firefly_0
          top.usr.e1_a_1
          top.usr.e2_a_1
          top.usr.e3_a_1
     ...
     (let
      ...
      (let
       ...
       (and
        ...
        (let
         ((X5 Bool top.res.abs_6))
         (and
          (= top.res.abs_7 (+ (+ (+ X1 X2) X3) X4))
          (__node_init_firefly_0
           top.usr.e1
           top.usr.e2
           top.usr.e3
