     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (let
         ((X6 Int top.res.abs_1_a_0))
         (let
          ((X7 Int top.res.abs_0_a_0))
          (and
           (=
            top.usr.OK_a_0
            (=>
             ...
             (and
              (and
               (not X2)
               (= (+ (+ (+ (+ X7 X6) X5) X4) X3) top.res.abs_10_a_0))
              (>= X7 0))))
           (= top.res.abs_9_a_0 (+ (+ (+ (+ X7 X6) X5) X4) X3))
           (__node_init_DRAGON_0
            top.usr.e01_a_0
            top.usr.e02_a_0
            top.usr.e03_a_0
            ...
            (=>
             ...
             (and
              (and
               (and
                (not X2)
                (= (+ (+ (+ (+ X7 X6) X5) X4) X3) top.res.abs_9_a_0))
               (= (+ (+ (+ (+ X7 X6) X5) X4) X3) top.res.abs_10_a_1))
              (>= X7 0))))
           (= top.res.abs_9_a_1 (+ (+ (+ (+ X7 X6) X5) X4) X3))
           (__node_trans_DRAGON_0
            top.usr.e01_a_1
            top.usr.e02_a_1
            top.usr.e03_a_1
           ...
           (=
            ...
            (=>
             ...
             (and
              (and
               (not X2)
               (= (+ (+ (+ (+ X7 X6) X5) X4) X3) top.res.abs_10))
              (>= X7 0))))
           (= top.res.abs_9 (+ (+ (+ (+ X7 X6) X5) X4) X3))
           (__node_init_DRAGON_0
            top.usr.e01
            top.usr.e02
            top.usr.e03
