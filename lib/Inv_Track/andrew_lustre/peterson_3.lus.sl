...
(define-fun
  ...
  (let
   ((X1 Int top.res.abs_2_a_0))
   (and
    (= top.res.abs_15_a_0 (and top.res.abs_14_a_0 (< X1 32767)))
    (let
     ((X2 Bool top.res.abs_16_a_0))
     (and
...
(define-fun
  ...
  (let
   ((X1 Int top.res.abs_2_a_1))
   (and
    (= top.res.abs_15_a_1 (and top.res.abs_14_a_1 (< X1 32767)))
    (let
     ((X2 Bool top.res.abs_16_a_1))
     (and
...
(define-fun
  ...
  (let
   ((X1 Int top.res.abs_2))
   (and
    (= top.res.abs_15 (and top.res.abs_14 (< X1 32767)))
    (let
     ((X2 Bool top.res.abs_16))
     (and
      (= top.usr.OK (=> X2 (>= X1 0)))
      (__node_init_peterson_0
       top.usr.e01
