     ...
     (or
      (or
       (or
        (or
         (or
          (or excludes4.usr.X1_a_0 excludes4.usr.X2_a_0)
     ...
     (or
      (or
       (or
        (or
         (or
          (or excludes4.usr.X1_a_1 excludes4.usr.X2_a_1)
...
(define-fun
  ...
  (let
   ...
   (and
    (= top.res.abs_5_a_0 (and top.res.abs_4_a_0 (>= X1 0)))
    (let
     ((X2 Bool top.res.abs_6_a_0))
     (let
      ((X3 Int top.res.abs_2_a_0))
      (and
       (= top.usr.OK_a_0 (=> X2 (or (<= X1 1) (<= X3 1))))
       (__node_init_mesi_0
...
(define-fun
  ...
  (let
   ...
   (and
    (= top.res.abs_5_a_1 (and top.res.abs_4_a_1 (>= X1 0)))
    (let
     ((X2 Bool top.res.abs_6_a_1))
     (let
      ((X3 Int top.res.abs_2_a_1))
      (and
       (= top.usr.OK_a_1 (=> X2 (or (<= X1 1) (<= X3 1))))
       (__node_trans_mesi_0
...
(define-fun
  ...
  (let
   ...
   (and
    (= top.res.abs_5 (and top.res.abs_4 (>= X1 0)))
    (let
     ((X2 Bool top.res.abs_6))
     (let
      ((X3 Int top.res.abs_2))
      (and
       (= top.usr.OK (=> X2 (or (<= X1 1) (<= X3 1))))
       (__node_init_mesi_0
        top.usr.etat_me1
        top.usr.etat_me2
        top.usr.etat_me3
