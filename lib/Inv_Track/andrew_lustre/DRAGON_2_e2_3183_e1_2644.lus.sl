      ...
      ((X4
        Bool (and
              ...
              (>=
               (+
                (+
                 (+ (+ (- DRAGON.usr.dirty_a_0 1) DRAGON.usr.shared_a_0) 1)
                 DRAGON.usr.exclusive_a_0)
                DRAGON.usr.shared_dirty_a_0)
               1))))
      (let
      ...
      (let
       ...
       (let
        ...
        (and
         (=
          top.res.abs_7_a_0
          (and top.res.abs_6_a_0 (> top.usr.init_invalid_a_0 0)))
         (let
          ((X6 Bool top.res.abs_8_a_0))
          (and
           (= top.res.abs_9_a_0 (+ (+ (+ (+ X1 X2) X3) X4) X5))
           (__node_init_DRAGON_0
            top.usr.e01_a_0
            top.usr.e02_a_0
            top.usr.e03_a_0
       ...
       (let
        ...
        (let
         ...
         (and
          (=
           top.usr.OK_a_1
           (=> X1 (= (+ (+ (+ (+ X6 X5) X4) X3) X2) top.res.abs_9_a_0)))
          (= top.res.abs_9_a_1 (+ (+ (+ (+ X6 X5) X4) X3) X2))
          (__node_trans_DRAGON_0
           top.usr.e01_a_1
           top.usr.e02_a_1
           top.usr.e03_a_1
      ...
      (let
       ...
       (let
        ...
        (and
         ...
         (let
          ((X6 Bool top.res.abs_8))
          (and
           (= top.res.abs_9 (+ (+ (+ (+ X1 X2) X3) X4) X5))
           (__node_init_DRAGON_0
            top.usr.e01
            top.usr.e02
            top.usr.e03
        ...
        (let
         ...
         (let
          ...
          (and
           (=
            top.usr.OK!
            (=> X1 (= (+ (+ (+ (+ X6 X5) X4) X3) X2) top.res.abs_9)))
           (= top.res.abs_9! (+ (+ (+ (+ X6 X5) X4) X3) X2))
           (__node_trans_DRAGON_0
            top.usr.e01!
            top.usr.e02!
            top.usr.e03!
