...
(define-fun
  ...
  (let
   ((X1 0))
   (let
    ((X2 (ite (not (= X1 1)) 1 X1)))
    (and
     (= top.usr.OK_a_0 (or (= X2 1) (and (>= X2 2) (<= X2 8))))
     (let
      ((X3 (>= top.usr.carSpeed_a_0 15.0)))
      (let
       ((X4 (= top.usr.carGear_a_0 3)))
       (let
        ((X5
          (and
                (and
        ...
        (let
         ...
         (and
          ...
          (let
           ((X7 (and (not X6) top.impl.usr.zz183_a_0)))
           (let
            ((X8 true))
            (and
             (= top.impl.usr.zz178_a_0 top.usr.accelResume_a_0)
             (let
              ((X9 (and (not X8) top.impl.usr.zz178_a_0)))
              (let
               ((X10 0))
               (let
                ((X11 (+ X10 1)))
                (let
                 ((X12 (ite top.usr.decelSet_a_0 X11 0)))
                 (let
                  ((X13 (ite (>= 0 X12) 0 X12)))
                  (and
                   (= top.impl.usr.zz176_a_0 (ite (<= X13 20) X13 20))
                   (let
                    ((X14 (= top.impl.usr.zz176_a_0 20)))
                    (let
                     ((X15 0))
                     (let
                      ((X16 (+ X15 1)))
                      (let
                       ((X17 (ite top.usr.accelResume_a_0 X16 0)))
                       (let
                        ((X18 (ite (>= 0 X17) 0 X17)))
                        (and
                         (= top.impl.usr.zz170_a_0 (ite (<= X18 20) X18 20))
                         (let
                          ((X19 (= top.impl.usr.zz170_a_0 20)))
                          (and
                           ...
                           (let
                            ...
                            (let
                             ...
                             (let
                              ((X22
                                (ite (and (>= X1 3) (<= X1 6)) X21 X1)))
                              (let
                               ((X23 (ite (= X22 5) 3 X22)))
                               (let
                                ((X24
                                  (ite (and (>= X1 3) (<= X1 6)) X23 X22)))
                                (let
                                 ((X25 (ite (= X24 6) 3 X24)))
                                 (let
                                  ((X26
  ...
  (let
   ...
   (let
    ...
    (and
     ...
     (let
      ((X3 (>= top.usr.carSpeed_a_1 15.0)))
      (let
       ((X4 (= top.usr.carGear_a_1 3)))
       (let
        ((X5
          (and
                (and
        ...
        (let
         ((X6 top.impl.usr.zz183_a_0))
         (and
          (= top.impl.usr.zz183_a_1 top.usr.decelSet_a_1)
          (let
           ((X7 (and (not X6) top.impl.usr.zz183_a_1)))
           (let
            ((X8 top.impl.usr.zz178_a_0))
            (and
             (= top.impl.usr.zz178_a_1 top.usr.accelResume_a_1)
             (let
              ((X9 (and (not X8) top.impl.usr.zz178_a_1)))
              (let
               ((X10 top.impl.usr.zz176_a_0))
               (let
                ((X11 (+ X10 1)))
                (let
                 ((X12 (ite top.usr.decelSet_a_1 X11 0)))
                 (let
                  ((X13 (ite (>= 0 X12) 0 X12)))
                  (and
                   (= top.impl.usr.zz176_a_1 (ite (<= X13 20) X13 20))
                   (let
                    ((X14 (= top.impl.usr.zz176_a_1 20)))
                    (let
                     ((X15 top.impl.usr.zz170_a_0))
                     (let
                      ((X16 (+ X15 1)))
                      (let
                       ((X17 (ite top.usr.accelResume_a_1 X16 0)))
                       (let
                        ((X18 (ite (>= 0 X17) 0 X17)))
                        (and
                         (= top.impl.usr.zz170_a_1 (ite (<= X18 20) X18 20))
                         (let
                          ((X19 (= top.impl.usr.zz170_a_1 20)))
                          (and
                           (=
  ...
  (let
   ...
   (let
    ...
    (and
     ...
     (let
      ((X3 (>= top.usr.carSpeed 15.0)))
      (let
       ((X4 (= top.usr.carGear 3)))
       (let
        ((X5
          (and
                (and
        ...
        (let
         ...
         (and
          ...
          (let
           ((X7 (and (not X6) top.impl.usr.zz183)))
           (let
            ((X8 true))
            (and
             (= top.impl.usr.zz178 top.usr.accelResume)
             (let
              ((X9 (and (not X8) top.impl.usr.zz178)))
              (let
               ((X10 0))
               (let
                ((X11 (+ X10 1)))
                (let
                 ((X12 (ite top.usr.decelSet X11 0)))
                 (let
                  ((X13 (ite (>= 0 X12) 0 X12)))
                  (and
                   (= top.impl.usr.zz176 (ite (<= X13 20) X13 20))
                   (let
                    ((X14 (= top.impl.usr.zz176 20)))
                    (let
                     ((X15 0))
                     (let
                      ((X16 (+ X15 1)))
                      (let
                       ((X17 (ite top.usr.accelResume X16 0)))
                       (let
                        ((X18 (ite (>= 0 X17) 0 X17)))
                        (and
                         (= top.impl.usr.zz170 (ite (<= X18 20) X18 20))
                         (let
                          ((X19 (= top.impl.usr.zz170 20)))
                          (and
       ...
       (let
        ((X5
          (and
                ...
                top.usr.validInputs!)))
        (let
         ((X6 top.impl.usr.zz183))
         (and
          (= top.impl.usr.zz183! top.usr.decelSet!)
          (let
           ((X7 (and (not X6) top.impl.usr.zz183!)))
           (let
            ((X8 top.impl.usr.zz178))
            (and
             (= top.impl.usr.zz178! top.usr.accelResume!)
             (let
              ((X9 (and (not X8) top.impl.usr.zz178!)))
              (let
               ((X10 top.impl.usr.zz176))
               (let
                ((X11 (+ X10 1)))
                (let
                 ((X12 (ite top.usr.decelSet! X11 0)))
