       ...
       (let
        ...
        (and
         (=
          ...
          true)
         (let
          ((X6 (ite (not top.usr.onOff_a_0) 0 1)))
          (let
           ((X7
             (and
                   (and (>= X5 2) (<= X5 8))
           ...
           (let
            ((X8 (ite X7 (ite (and (>= X5 2) (<= X5 8)) 0 X5) X5)))
            (let
             ((X9 (ite X7 (ite (not (= X8 1)) 1 X8) X8)))
             (let
              ((X10
                (and
                      (= X9 1)
              ...
              (let
               ((X11 (ite X10 (ite (= X9 1) 0 X9) X9)))
               (let
                ((X12 (ite (not (and (>= X11 2) (<= X11 8))) 2 X11)))
                (let
                 ((X13
                   (and
                         (not (and (>= X11 2) (<= X11 8)))
                         (and (>= X12 2) (<= X12 8)))))
                 (let
                  ((X14 (ite X13 (ite (not (= X12 7)) 7 X12) X12)))
                  (let
                   ((X15 (ite X10 X14 X11)))
                   (let
                    ((X16 (or X10 X7)))
        ...
        (and
         (=
          ...
          (ite
           ...
           top.impl.usr.chart_CruiseController_ModeLogic_mode_logic_rlt_evtInitStep_a_0))
         (let
          ((X6 (ite (not top.usr.onOff_a_1) 0 1)))
          (let
           ((X7
             (and
                   (and (>= X5 2) (<= X5 8))
