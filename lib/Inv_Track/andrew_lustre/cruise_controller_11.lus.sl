        ...
        (let
         ...
         (and
          (=
           ...
           true)
          (let
           ((X7 (ite (not top.usr.onOff_a_0) 0 1)))
           (let
            ((X8
              (and
                    (and (>= X6 2) (<= X6 8))
            ...
            (let
             ((X9 (ite X8 (ite (and (>= X6 2) (<= X6 8)) 0 X6) X6)))
             (let
              ((X10 (ite X8 (ite (not (= X9 1)) 1 X5) X5)))
              (let
               ((X11 (ite X8 (ite (not (= X9 1)) 1 X9) X9)))
               (let
                ((X12
                  (and
                        (= X11 1)
                ...
                (let
                 ((X13 (ite X12 (ite (= X11 1) 0 X11) X11)))
                 (let
                  ((X14 (ite (not (and (>= X13 2) (<= X13 8))) 2 X13)))
                  (let
                   ((X15
                     (and
                           (not (and (>= X13 2) (<= X13 8)))
                   ...
                   (let
                    ((X16
                      (ite
                           ...
                           X10)))
                    (let
                     ((X17 (ite X15 (ite (not (= X14 7)) 7 X14) X14)))
                     (let
                      ((X18 (ite X12 X17 X13)))
                      (let
                       ((X19 (or X12 X8)))
                       (let
                        ...
                        (let
                         ...
                         (let
                          ...
                          (let
                           ((X23
                             (ite X21 (ite (not (= X22 8)) 8 X22) X22)))
                           (let
                            ((X24 (ite (not X2) 0 1)))
                            (let
                             ((X25
                               (and
                                     ...
                                     (and
                                      ...
                                      (not X21)))))
                             (let
                              ((X26 (ite X25 (ite (= X23 8) 2 X23) X23)))
                              (let
                               ((X27
                                 (ite
                                      (not (and (>= X26 3) (<= X26 6)))
     ...
     (ite
           ...
           (ite
            ...
            (ite
             ...
             top.impl.usr.cruise_controller_CruiseController_SetDesiredSpeed_IncreaseDesiredSpeed_a_0)))))
   (let
    ((X2 (and (not top.usr.decelSet_a_0) top.usr.decelSet_a_1)))
    (let
     ((X3
       (and
             (and
     ...
     (let
      ((X4 (and (not top.usr.accelResume_a_0) top.usr.accelResume_a_1)))
      (and
       (=
         ...
         (and
          (=
           ...
           (ite
            ...
            top.impl.usr.chart_CruiseController_ModeLogic_mode_logic_rlt_evtInitStep_a_0))
          (let
           ((X7 (ite (not top.usr.onOff_a_1) 0 1)))
           (let
            ((X8
              (and
                    (and (>= X6 2) (<= X6 8))
     ...
     (ite
           ...
           (ite
            ...
            (ite
             ...
             top.impl.usr.cruise_controller_CruiseController_SetDesiredSpeed_IncreaseDesiredSpeed)))))
   (let
    ((X2 (and (not top.usr.decelSet) top.usr.decelSet!)))
    (let
     ((X3
       (and
             (and
             ...
             top.usr.validInputs!)))
     (let
      ((X4 (and (not top.usr.accelResume) top.usr.accelResume!)))
      (and
       (=
        top.impl.usr.cruise_controller_CruiseController_ModeLogic_DelayOnsetDecel_Bounded_Count_Out!
        (ite
