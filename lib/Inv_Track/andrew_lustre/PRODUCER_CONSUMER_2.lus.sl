...
(define-fun
  ...
  (and
   (= top.res.abs_5_a_0 (not (and top.usr.etat2_a_0 top.usr.etat3_a_0)))
   (let
    ((X1
      Bool (and
    ...
    (let
     ...
     (and
      ...
      (__node_init_First_0 top.usr.a_init_a_0 top.res.abs_7_a_0 top.res.inst_0_a_0)
...
(define-fun
  ...
  (and
   (= top.res.abs_5_a_1 (not (and top.usr.etat2_a_1 top.usr.etat3_a_1)))
   (let
    ((X1 Bool (and top.res.abs_6_a_1 (> top.res.abs_7_a_1 0))))
    (let
...
(define-fun
  ...
  (and
   (= top.res.abs_5 (not (and top.usr.etat2 top.usr.etat3)))
   (let
    ((X1
      Bool (and (and top.res.abs_6 (not top.usr.etat1)) (> top.res.abs_7 0))))
    (let
...
(define-fun
  ...
  (and
   (and
    (= top.res.abs_5! (not (and top.usr.etat2! top.usr.etat3!)))
    (let
     ((X1 Bool (and top.res.abs_6! (> top.res.abs_7! 0))))
     (let
      ((X2 Int top.res.abs_0!))
      (and
       (= top.usr.OK! (=> X1 (>= X2 0)))
