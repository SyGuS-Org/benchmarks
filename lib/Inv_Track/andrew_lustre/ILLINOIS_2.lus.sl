    ...
    (let
     ...
     (let
      ...
      (let
       ...
       (let
        ((X5 Bool top.res.abs_5_a_0))
        (and
         (= top.res.abs_6_a_0 (+ (+ (+ X1 X2) X3) X4))
         (__node_init_illinois_0
          top.usr.e1_a_0
          top.usr.e2_a_0
          top.usr.e3_a_0
    ...
    (let
     ...
     (let
      ...
      (let
       ...
       (and
        (= top.usr.OK_a_1 (=> X1 (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_6_a_0)))
        (= top.res.abs_6_a_1 (+ (+ (+ X5 X4) X3) X2))
        (__node_trans_illinois_0
         top.usr.e1_a_1
         top.usr.e2_a_1
         top.usr.e3_a_1
    ...
    (let
     ...
     (let
      ...
      (let
       ...
       (let
        ((X5 Bool top.res.abs_5))
        (and
         (= top.res.abs_6 (+ (+ (+ X1 X2) X3) X4))
         (__node_init_illinois_0
          top.usr.e1
          top.usr.e2
          top.usr.e3
     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (and
         (= top.usr.OK! (=> X1 (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_6)))
         (= top.res.abs_6! (+ (+ (+ X5 X4) X3) X2))
         (__node_trans_illinois_0
          top.usr.e1!
          top.usr.e2!
          top.usr.e3!
