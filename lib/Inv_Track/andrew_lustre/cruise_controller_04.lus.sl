...
(define-fun
  ...
  (let
   ((X1 0))
   (let
    ((X2 (ite (not top.usr.onOff_a_0) 0 1)))
    (let
     ((X3
       (and
             (and (>= X1 2) (<= X1 8))
     ...
     (let
      ((X4 (ite X3 (ite (and (>= X1 2) (<= X1 8)) 0 X1) X1)))
      (let
       ((X5 (ite X3 (ite (not (= X4 1)) 1 X4) X4)))
       (let
        ((X6
          (and (= X5 1) (and (ite (not (= X2 0)) true false) (not X3)))))
        (let
         ((X7 (ite X6 (ite (= X5 1) 0 X5) X5)))
         (let
          ((X8 (ite (not (and (>= X7 2) (<= X7 8))) 2 X7)))
          (let
           ((X9
             (and
                   (not (and (>= X7 2) (<= X7 8)))
                   (and (>= X8 2) (<= X8 8)))))
           (let
            ((X10 (ite X9 (ite (not (= X8 7)) 7 X8) X8)))
            (let
             ((X11
               (or (and (>= X10 3) (<= X10 6)) (or (= X10 7) (= X10 8)))))
             (and
              (= top.usr.OK_a_0 X11)
              (let
               ((X12 false))
                       ...
                       (let
                        ((X20
                          (ite
                               ...
                               X16)))
                        (let
                         ((X21 (ite X19 (ite (not (= X20 8)) 8 X20) X20)))
                         (let
                          ((X22 (ite (not X12) 0 1)))
                          (let
                           ((X23
                             (and
                                   ...
                                   (and
                                    ...
                                    (not X19)))))
                           (let
                            ((X24 (ite X23 (ite (= X21 8) 2 X21) X21)))
                            (let
                             ((X25
                               (ite
                                    (not (and (>= X24 3) (<= X24 6)))
...
(define-fun
  ...
  (let
   ((X1
     top.impl.usr.chart_CruiseController_ModeLogic_mode_logic_final_state_states___root_a_0))
   (let
    ((X2 (ite (not top.usr.onOff_a_1) 0 1)))
    (let
     ((X3
       (and
             (and (>= X1 2) (<= X1 8))
           ...
           (let
            ...
            (let
             ...
             (and
              (= top.usr.OK_a_1 X11)
              (let
               ((X12 (and (not top.usr.decelSet_a_0) top.usr.decelSet_a_1)))
               (let
                ((X13
                  (and
                        (and
           ...
           (let
            ...
            (let
             ...
             (and
              (= top.usr.OK! X11)
              (let
               ((X12 (and (not top.usr.decelSet) top.usr.decelSet!)))
               (let
                ((X13
                  (and
                        (and
                ...
                (let
                 ((X14
                   (and (not top.usr.accelResume) top.usr.accelResume!)))
                 (and
                  (=
                   top.impl.usr.cruise_controller_CruiseController_ModeLogic_DelayOnsetDecel_Bounded_Count_Out!
                   (ite
