       ...
       (and
        (=
         ...
         (=>
          X1
          (and
           (and (< X2 2) (= (+ (+ X4 X3) X2) top.res.abs_8_a_0))
           (or (< X2 1) (< X3 1)))))
       ...
       (and
        (=
         ...
         (=>
          ...
          (and
           (and
            (and (< X2 2) (= (+ (+ X4 X3) X2) top.res.abs_7_a_0))
            (= (+ (+ X4 X3) X2) top.res.abs_8_a_1))
           (or (< X2 1) (< X3 1)))))
       ...
       (and
        (=
         ...
         (=>
          X1
          (and
           (and (< X2 2) (= (+ (+ X4 X3) X2) top.res.abs_8))
           (or (< X2 1) (< X3 1)))))
        ...
        (and
         (=
          ...
          (=>
           ...
           (and
            (and
             (and (< X2 2) (= (+ (+ X4 X3) X2) top.res.abs_7))
             (= (+ (+ X4 X3) X2) top.res.abs_8!))
            (or (< X2 1) (< X3 1)))))
         (= top.res.abs_7! (+ (+ X4 X3) X2))
         (__node_trans_synapse_0
          top.usr.e_s1!
