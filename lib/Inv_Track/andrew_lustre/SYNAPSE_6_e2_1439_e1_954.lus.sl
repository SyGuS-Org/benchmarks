     ...
     (and
      (=
       ...
       (ite
        ...
        (ite
         X3
         (- (+ (- synapse.usr.invalid_s_a_0 1) synapse.usr.dirty_s_a_0) 1)
        ...
        (ite
         ...
         (ite
          ...
          (-
           (+
            (+ (+ synapse.usr.invalid_s_a_0 1) synapse.usr.dirty_s_a_0)
  ...
  (and
   ...
   (let
    ...
    (let
     ...
     (and
      (= top.usr.OK_a_0 (=> X1 (<= X2 top.res.abs_7_a_0)))
      (__node_init_synapse_0
       top.usr.e_s1_a_0
       top.usr.e_s2_a_0
       top.usr.e_s3_a_0
       ...
       top.res.abs_3_a_0
       top.res.inst_3_a_0)
      (__node_init_Sofar_0 top.res.abs_5_a_0 top.res.abs_6_a_0 top.res.inst_2_a_0)
      (__node_init_excludes3_0
       top.usr.e_s1_a_0
       top.usr.e_s2_a_0
       top.usr.e_s3_a_0
  ...
  (and
   ...
   (let
    ...
    (let
     ...
     (and
      (= top.usr.OK_a_1 (=> X1 (<= X2 top.res.abs_7_a_1)))
      (__node_trans_synapse_0
       top.usr.e_s1_a_1
       top.usr.e_s2_a_1
       top.usr.e_s3_a_1
  ...
  (and
   ...
   (let
    ...
    (let
     ...
     (and
      (= top.usr.OK (=> X1 (<= X2 top.res.abs_7)))
      (__node_init_synapse_0
       top.usr.e_s1
       top.usr.e_s2
       top.usr.e_s3
