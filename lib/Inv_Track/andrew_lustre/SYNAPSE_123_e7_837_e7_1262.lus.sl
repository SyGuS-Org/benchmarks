  ...
  (and
   (=
    ...
    (not
     (or
      (or
       (or excludes3.usr.X1_a_0 excludes3.usr.X2_a_0)
  ...
  (and
   (=
    ...
    (not
     (or
      (or
       (or excludes3.usr.X1_a_1 excludes3.usr.X2_a_1)
...
(define-fun
  ...
  (and
   (= top.res.abs_5_a_0 (and top.res.abs_4_a_0 (>= top.usr.init_invalid_s_a_0 0)))
   (let
    ...
    (let
     ...
     (let
      ...
      (let
       ...
       (let
        ((X5 Bool (=> X1 (= (+ (+ X4 X3) X2) top.res.abs_8_a_0))))
        (let
         ((X6 Bool true))
         (let
          ((X7 Bool (=> X1 (< X2 2))))
          (and
           (= top.usr.OK_a_0 (and (and X6 X7) X5))
           (= top.res.abs_7_a_0 (+ (+ X4 X3) X2))
           (__node_init_synapse_0
            top.usr.e_s1_a_0
            top.usr.e_s2_a_0
            top.usr.e_s3_a_0
    ...
    (let
     ...
     (let
      ...
      (let
       ...
       (let
        ((X5 Bool (=> X1 (= (+ (+ X4 X3) X2) top.res.abs_8_a_1))))
        (let
         ((X6 Bool (=> X1 (= (+ (+ X4 X3) X2) top.res.abs_7_a_0))))
         (let
          ((X7 Bool (=> X1 (< X2 2))))
          (and
           (= top.usr.OK_a_1 (and (and X6 X7) X5))
    ...
    (let
     ...
     (let
      ...
      (let
       ...
       (let
        ((X5 Bool (=> X1 (= (+ (+ X4 X3) X2) top.res.abs_8))))
        (let
         ((X6 Bool true))
         (let
          ((X7 Bool (=> X1 (< X2 2))))
          (and
           (= top.usr.OK (and (and X6 X7) X5))
      ...
      (let
       ...
       (let
        ...
        (let
         ((X5 Bool (=> X1 (= (+ (+ X4 X3) X2) top.res.abs_8!))))
         (let
          ((X6 Bool (=> X1 (= (+ (+ X4 X3) X2) top.res.abs_7))))
          (let
           ((X7 Bool (=> X1 (< X2 2))))
           (and
            (= top.usr.OK! (and (and X6 X7) X5))
