...
(define-fun PreF ((x1 Int) (x2 Int) (x3 Int) (d1 Int) (d2 Int) (d3 Int)) Bool
    (and (= d1 1) (and (= d2 1) (= d3 1))))
(define-fun TransF ((x1 Int) (x2 Int) (x3 Int) (d1 Int) (d2 Int) (d3 Int) (x1! Int) (x2! Int) (x3! Int) (d1! Int) (d2! Int) (d3! Int)) Bool
...
(define-fun PostF ((x1 Int) (x2 Int) (x3 Int) (d1 Int) (d2 Int) (d3 Int)) Bool
