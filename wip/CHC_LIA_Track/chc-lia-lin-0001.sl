...
(constraint (forall ((cleaned_symbol_7 Int) (cleaned_symbol_8 Int) (cleaned_symbol_9 Int)) (let ((a!1 (and (= (not (= 0 cleaned_symbol_7)) (<= cleaned_symbol_8 cleaned_symbol_9)) (not (not (= 0 cleaned_symbol_7))) (cleaned_symbol_0 cleaned_symbol_9 cleaned_symbol_8)))) (=> a!1 false))))
