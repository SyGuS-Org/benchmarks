...
(constraint (implies (and false (inv x n)) (= x n)))
(constraint (implies (inv x n) (inv x n)))
(constraint (implies (and3 (inv x n) (= x1 (+ x 1)) (< x1 n)) (inv x1 n)))
(constraint (implies (and3 (inv x n) (= x1 (+ x 1)) (>= x1 n)) (= x1 n)))
