...
(constraint (or (= x1 (mux_6 x1 x2 x3 x4 x5 x6))
            (or (= x2 (mux_6 x1 x2 x3 x4 x5 x6))
            (or (= x3 (mux_6 x1 x2 x3 x4 x5 x6))
            (or (= x4 (mux_6 x1 x2 x3 x4 x5 x6))
            (or (= x5 (mux_6 x1 x2 x3 x4 x5 x6))
	        (= x6 (mux_6 x1 x2 x3 x4 x5 x6))))))))
