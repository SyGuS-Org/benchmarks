        ...
        (and
         (=
          ...
          (=>
           X1
           (and
            (and (< X3 2) (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_8_a_0))
            (>= X3 0))))
         (= top.res.abs_7_a_0 (+ (+ (+ X5 X4) X3) X2))
         (__node_init_illinois_0
          top.usr.e1_a_0
          top.usr.e2_a_0
          top.usr.e3_a_0
        ...
        (and
         (=
          ...
          (=>
           ...
           (and
            (and
             (and (< X3 2) (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_7_a_0))
             (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_8_a_1))
            (>= X3 0))))
        ...
        (and
         (=
          ...
          (=>
           X1
           (and
            (and (< X3 2) (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_8))
            (>= X3 0))))
         ...
         (and
          (=
           ...
           (=>
            ...
            (and
             (and
              (and (< X3 2) (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_7))
              (= (+ (+ (+ X5 X4) X3) X2) top.res.abs_8!))
             (>= X3 0))))
          (= top.res.abs_7! (+ (+ (+ X5 X4) X3) X2))
          (__node_trans_illinois_0
           top.usr.e1!
