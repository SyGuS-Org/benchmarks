...
(define-fun
  ...
  (and
   ...
   (let
    ...
    (let
     ((X2 Int top.res.abs_0_a_0))
     (and
      (= top.usr.OK_a_0 (=> X1 (and (<= 0 X2) (<= X2 3))))
      (__node_init_ticket3i_0
       top.usr.e1_a_0
       top.usr.e2_a_0
       top.usr.e3_a_0
...
(define-fun
  ...
  (and
   ...
   (let
    ...
    (let
     ((X2 Int top.res.abs_0_a_1))
     (and
      (= top.usr.OK_a_1 (=> X1 (and (<= 0 X2) (<= X2 3))))
      (__node_trans_ticket3i_0
       top.usr.e1_a_1
       top.usr.e2_a_1
       top.usr.e3_a_1
...
(define-fun
  ...
  (and
   ...
   (let
    ...
    (let
     ((X2 Int top.res.abs_0))
     (and
      (= top.usr.OK (=> X1 (and (<= 0 X2) (<= X2 3))))
      (__node_init_ticket3i_0
       top.usr.e1
       top.usr.e2
       top.usr.e3
