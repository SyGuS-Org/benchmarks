                  ...
                  (and
                   ...
                   (and
                    ...
                    (ite
                     ...
                     false))))))
          (let
           ((X7 Int (ite X6 (ite (= X1 4) 0 X1) X1)))
           (let
            ((X8 Int (ite (not (and (>= X7 1) (<= X7 3))) 1 X7)))
            (let
             ((X9
               Bool (and
                     (not (and (>= X7 1) (<= X7 3)))
                     (and (>= X8 1) (<= X8 3)))))
             (let
              ((X10 Int (ite (not top.usr.DOOR_CLOSED_a_0) 0 1)))
              (let
               ((X11
                 Bool (and
                       X9
                       (and
                        (and (>= X8 1) (<= X8 3))
                        (ite (not (= X10 0)) true false)))))
               (let
                ((X12 Int (ite X11 (ite (not (= X8 2)) 2 X8) X8)))
                (let
                 ((X13
                   Bool (and X9 (and (and (>= X12 1) (<= X12 3)) (not X11)))))
                 (let
                  ((X14 Int (ite X13 (ite (not (= X12 3)) 3 X12) X12)))
                  (and
                   (= top.usr.OK_a_0 (or (= X14 2) (= X14 3)))
                   (let
                    ((X15 Int 0))
                    (let
                     ((X16 Int 0))
                     (and
                      (=
                       ...
                       true)
                      (let
                       ((X17 Int (ite X11 (ite (not (= X8 2)) 2 X16) X16)))
                       (let
                        ((X18
                          Int (ite
                               X6
                               (ite X13 (ite (not (= X12 3)) 3 X17) X17)
                               X16)))
                        (let
                         ((X19 Int (ite X6 X14 X7)))
                         (let
                          ((X20
                            Int (ite X2 top.impl.usr.STEPS_TO_COOK_a_0 X15)))
                          (let
                           ((X21
           ...
           Bool (and
                 ...
                 (and
                  ...
                  (and
                   ...
                   (ite
                    (not
                     (= (ite (not (> top.impl.usr.STEPS_TO_COOK_a_1 0)) 0 1) 0))
                    true
                    false))))))
         (let
          ((X7 Int (ite X6 (ite (= X1 4) 0 X1) X1)))
           ...
           (let
            ((X9
              Bool (and
                    ...
                    (and (>= X8 1) (<= X8 3)))))
            (let
             ((X10 Int (ite (not top.usr.DOOR_CLOSED_a_1) 0 1)))
             (let
              ((X11
                Bool (and
                      X9
              ...
              (let
               ...
               (let
                ...
                (let
                 ((X14 Int (ite X13 (ite (not (= X12 3)) 3 X12) X12)))
                 (and
                  (= top.usr.OK_a_1 (or (= X14 2) (= X14 3)))
                  (let
                   ((X15
                     Int top.impl.usr.chart_microwave_mode_logic_steps_remaining_a_0))
                   (let
                    ((X16 Int top.impl.usr.chart_microwave_mode_logic_mode_a_0))
                    (and
                     (=
                     ...
                     (let
                      ...
                      (let
                       ...
                       (let
                        ((X19 Int (ite X6 X14 X7)))
                        (let
                         ((X20 Int (ite X2 top.impl.usr.STEPS_TO_COOK_a_1 X15)))
                         (let
                          ((X21
                            Bool (and (and (= X19 2) (<= X20 0)) (= X19 2))))
                          (let
            ...
            Bool (and
                  ...
                  (and
                   ...
                   (and
                    ...
                    (ite
                     (not
                      (= (ite (not (> top.impl.usr.STEPS_TO_COOK 0)) 0 1) 0))
                     true
                     false))))))
          (let
           ((X7 Int (ite X6 (ite (= X1 4) 0 X1) X1)))
            ...
            (let
             ((X9
               Bool (and
                     ...
                     (and (>= X8 1) (<= X8 3)))))
             (let
              ((X10 Int (ite (not top.usr.DOOR_CLOSED) 0 1)))
              (let
               ((X11
                 Bool (and
                       X9
                      ...
                      (let
                       ...
                       (let
                        ...
                        (let
                         ((X19 Int (ite X6 X14 X7)))
                         (let
                          ((X20 Int (ite X2 top.impl.usr.STEPS_TO_COOK X15)))
                          (let
                           ((X21
                             Bool (and (and (= X19 2) (<= X20 0)) (= X19 2))))
                           (let
  ...
  (and
   (let
    ...
    (let
     ((X2 Bool (= X1 4)))
     (let
      ((X3 Bool (and top.usr.KP_START! (not top.usr.KP_START))))
      (let
       ((X4 Int (ite (not X3) 0 1)))
       (let
        ((X5
                 ...
                 (let
                  ...
                  (and
                   ...
                   (let
                    ...
                    (let
                     ((X16 Int top.impl.usr.chart_microwave_mode_logic_mode))
                     (and
                      (=
                       top.impl.usr.chart_microwave_mode_logic_rlt_evtInitStep!
                       (ite
