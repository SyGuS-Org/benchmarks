...
(define-fun
  ...
  (let
   ((X1 Int top.res.abs_8_a_0))
   (let
    ((X2 Int top.res.abs_7_a_0))
    (let
     ((X3 Int top.res.abs_6_a_0))
     (let
      ((X4 Int top.res.abs_5_a_0))
      (let
       ((X5 Int top.res.abs_4_a_0))
       (let
        ((X6 Int top.res.abs_3_a_0))
        (let
         ((X7 Int top.res.abs_2_a_0))
         (let
          ((X8 Int top.res.abs_1_a_0))
          (let
           ((X9 Int top.res.abs_0_a_0))
           (and
            (=
             top.res.abs_11_a_0
             (and
               ...
               (and
                (and
                 (and
                  (and
                   (and
                    (and (and top.res.abs_10_a_0 (< X9 32767)) (< X8 32767))
                    (< X7 32767))
                   (< X6 32767))
                  (< X5 32767))
                 (< X4 32767))
              ...
              (< X1 32767)))
            (let
             ((X10 Bool top.res.abs_12_a_0))
             (let
              ((X11 Bool top.res.abs_9_a_0))
              (and
               (=
                top.usr.OK_a_0
                (=>
...
(define-fun
  ...
  (let
   ((X1 Int top.res.abs_8_a_1))
   (let
    ((X2 Int top.res.abs_7_a_1))
    (let
     ((X3 Int top.res.abs_6_a_1))
     (let
      ((X4 Int top.res.abs_5_a_1))
      (let
       ((X5 Int top.res.abs_4_a_1))
       (let
        ((X6 Int top.res.abs_3_a_1))
        (let
         ((X7 Int top.res.abs_2_a_1))
         (let
          ((X8 Int top.res.abs_1_a_1))
          (let
           ((X9 Int top.res.abs_0_a_1))
           (and
            (=
             top.res.abs_11_a_1
             (and
               ...
               (and
                (and
                 (and
                  (and
                   (and
                    (and (and top.res.abs_10_a_1 (< X9 32767)) (< X8 32767))
                    (< X7 32767))
                   (< X6 32767))
                  (< X5 32767))
                 (< X4 32767))
              ...
              (< X1 32767)))
            (let
             ((X10 Bool top.res.abs_12_a_1))
             (let
              ((X11 Bool top.res.abs_9_a_1))
              (and
               (=
                top.usr.OK_a_1
                (=>
...
(define-fun
  ...
  (let
   ((X1 Int top.res.abs_8))
   (let
    ((X2 Int top.res.abs_7))
    (let
     ((X3 Int top.res.abs_6))
     (let
      ((X4 Int top.res.abs_5))
      (let
       ((X5 Int top.res.abs_4))
       (let
        ((X6 Int top.res.abs_3))
        (let
         ((X7 Int top.res.abs_2))
         (let
          ((X8 Int top.res.abs_1))
          (let
           ((X9 Int top.res.abs_0))
           (and
            (=
             top.res.abs_11
             (and
               ...
               (and
                (and
                 (and
                  (and
                   (and
                    (and (and top.res.abs_10 (< X9 32767)) (< X8 32767))
                    (< X7 32767))
                   (< X6 32767))
                  (< X5 32767))
                 (< X4 32767))
              ...
              (< X1 32767)))
            (let
             ((X10 Bool top.res.abs_12))
             (let
              ((X11 Bool top.res.abs_9))
              (and
               (=
                top.usr.OK
                (=>
