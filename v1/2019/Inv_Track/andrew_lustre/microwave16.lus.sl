   ...
   (let
    ...
    (and
     ...
     (=
      top.usr.OK_a_0
      (or
       (not (and X1 top.usr.KP_CLEAR_a_0))
       (= top.impl.usr.STEPS_TO_COOK_a_0 0)))
     (let
      ((X2 Int 0))
      (let
       ((X3 Int 0))
  ...
  (let
   ...
   (and
    ...
    (=
     top.usr.OK_a_1
     (or
      (not (and X1 top.usr.KP_CLEAR_a_1))
      (= top.impl.usr.STEPS_TO_COOK_a_1 0)))
    (let
  ...
  (and
   ...
   (let
    ...
    (and
     ...
     (=
      top.usr.OK
      (or (not (and X1 top.usr.KP_CLEAR)) (= top.impl.usr.STEPS_TO_COOK 0)))
     (let
      ((X2 Int 0))
      (let
       ((X3 Int 0))
