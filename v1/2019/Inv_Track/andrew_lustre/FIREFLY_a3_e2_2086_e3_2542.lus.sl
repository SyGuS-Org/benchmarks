             ...
             (=
              ...
              (ite
               ...
               (ite
                ...
                (ite
                 X4
                 (- (+ (- firefly.usr.shared_a_0 1) firefly.usr.exclusive_a_0) 1)
...
(define-fun
  ...
  (and
   (= top.res.abs_5_a_0 (and top.res.abs_4_a_0 (>= top.usr.i_invalid_a_0 0)))
   (let
      ...
      (let
       ...
       (let
        ...
        (let
         ((X6 Bool (=> X1 (>= X5 0))))
         (let
          ((X7 Int top.res.abs_3_a_0))
          (let
           ((X8 Int top.res.abs_0_a_0))
           (let
            ((X9 Bool (=> X1 (<= (+ (+ (+ X8 X5) X3) X7) X2))))
            (let
             ((X10 Bool (=> X1 (<= X7 X2))))
             (and
              (= top.usr.OK_a_0 (and (and (and X9 X6) X4) X10))
              (__node_init_firefly_0
               top.usr.e1_a_0
               top.usr.e2_a_0
               top.usr.e3_a_0
...
(define-fun
  ...
  (and
   (= top.res.abs_5_a_1 (and top.res.abs_4_a_1 (>= top.usr.i_invalid_a_1 0)))
   (let
      ...
      (let
       ...
       (let
        ...
        (let
         ((X6 Bool (=> X1 (>= X5 0))))
         (let
          ((X7 Int top.res.abs_3_a_1))
          (let
           ((X8 Int top.res.abs_0_a_1))
           (let
            ((X9 Bool (=> X1 (<= (+ (+ (+ X8 X5) X3) X7) X2))))
            (let
             ((X10 Bool (=> X1 (<= X7 X2))))
             (and
              (= top.usr.OK_a_1 (and (and (and X9 X6) X4) X10))
              (__node_trans_firefly_0
               top.usr.e1_a_1
               top.usr.e2_a_1
               top.usr.e3_a_1
...
(define-fun
  ...
  (and
   (= top.res.abs_5 (and top.res.abs_4 (>= top.usr.i_invalid 0)))
   (let
      ...
      (let
       ...
       (let
        ...
        (let
         ((X6 Bool (=> X1 (>= X5 0))))
         (let
          ((X7 Int top.res.abs_3))
          (let
           ((X8 Int top.res.abs_0))
           (let
            ((X9 Bool (=> X1 (<= (+ (+ (+ X8 X5) X3) X7) X2))))
            (let
             ((X10 Bool (=> X1 (<= X7 X2))))
             (and
              (= top.usr.OK (and (and (and X9 X6) X4) X10))
              (__node_init_firefly_0
               top.usr.e1
               top.usr.e2
               top.usr.e3
