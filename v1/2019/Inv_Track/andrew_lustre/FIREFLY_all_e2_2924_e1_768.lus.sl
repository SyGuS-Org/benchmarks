...
(define-fun
  ...
  (and
   ...
   (let
    ((X1 Int top.res.abs_7_a_0))
    (let
     ((X2 Bool top.res.abs_6_a_0))
     (let
      ((X3 Int top.res.abs_3_a_0))
      (let
       ((X4 Int top.res.abs_2_a_0))
       (let
        ((X5 Int top.res.abs_1_a_0))
        (let
         ((X6 Int top.res.abs_0_a_0))
         (and
          (=
           top.usr.OK_a_0
           (=>
            ...
            (and
             (and
              (and
               (= (+ (+ (+ X6 X5) X4) X3) top.res.abs_7_a_0)
               (<= (+ (+ (+ X6 X5) X4) X3) X1))
              (>= X6 0))
             (<= X6 X1))))
          (= top.res.abs_8_a_0 (+ (+ (+ X6 X5) X4) X3))
          (__node_init_firefly_0
           top.usr.e1_a_0
           top.usr.e2_a_0
           top.usr.e3_a_0
...
(define-fun
  ...
  (and
   ...
   (let
    ((X1 Int top.res.abs_7_a_1))
    (let
     ((X2 Bool top.res.abs_6_a_1))
     (let
      ((X3 Int top.res.abs_3_a_1))
      (let
       ((X4 Int top.res.abs_2_a_1))
       (let
        ((X5 Int top.res.abs_1_a_1))
        (let
         ((X6 Int top.res.abs_0_a_1))
         (and
          (=
           top.usr.OK_a_1
           (=>
            ...
            (and
             (and
              (and
               (and
                (= (+ (+ (+ X6 X5) X4) X3) top.res.abs_8_a_0)
                (= (+ (+ (+ X6 X5) X4) X3) top.res.abs_7_a_1))
               (<= (+ (+ (+ X6 X5) X4) X3) X1))
              (>= X6 0))
             (<= X6 X1))))
          (= top.res.abs_8_a_1 (+ (+ (+ X6 X5) X4) X3))
          (__node_trans_firefly_0
           top.usr.e1_a_1
           top.usr.e2_a_1
           top.usr.e3_a_1
  ...
  (and
   (=
    ...
    (and
     ...
     (< top.usr.i_invalid 5)))
   (let
    ((X1 Int top.res.abs_7))
    (let
     ((X2 Bool top.res.abs_6))
     (let
      ((X3 Int top.res.abs_3))
      (let
       ((X4 Int top.res.abs_2))
       (let
        ((X5 Int top.res.abs_1))
        (let
         ((X6 Int top.res.abs_0))
         (and
          (=
           top.usr.OK
           (=>
            ...
            (and
             (and
              (and
               (= (+ (+ (+ X6 X5) X4) X3) top.res.abs_7)
               (<= (+ (+ (+ X6 X5) X4) X3) X1))
              (>= X6 0))
             (<= X6 X1))))
          (= top.res.abs_8 (+ (+ (+ X6 X5) X4) X3))
          (__node_init_firefly_0
           top.usr.e1
           top.usr.e2
           top.usr.e3
           ...
           top.res.inst_4
           top.res.inst_3)
          (__node_init_Sofar_0 top.res.abs_5 top.res.abs_6 top.res.inst_2)
          (__node_init_excludes8_0
           top.usr.e1
           top.usr.e2
           top.usr.e3
