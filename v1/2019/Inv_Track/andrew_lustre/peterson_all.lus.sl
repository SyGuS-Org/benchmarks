...
(define-fun
  __node_init_peterson_0 (
    (peterson.usr.e01_a_0 Bool)
    (peterson.usr.e02_a_0 Bool)
    (peterson.usr.e03_a_0 Bool)
    (peterson.usr.e04_a_0 Bool)
    (peterson.usr.e05_a_0 Bool)
    (peterson.usr.e06_a_0 Bool)
    (peterson.usr.e07_a_0 Bool)
    (peterson.usr.e08_a_0 Bool)
    (peterson.usr.e09_a_0 Bool)
    (peterson.usr.e10_a_0 Bool)
    (peterson.usr.e11_a_0 Bool)
    (peterson.usr.e12_a_0 Bool)
    (peterson.res.nondet_23 Int)
    (peterson.res.nondet_22 Int)
    (peterson.res.nondet_21 Int)
    (peterson.res.nondet_20 Int)
    (peterson.res.nondet_19 Int)
    (peterson.res.nondet_18 Int)
    (peterson.res.nondet_17 Int)
    (peterson.res.nondet_16 Int)
    (peterson.res.nondet_15 Int)
    (peterson.res.nondet_14 Int)
    (peterson.res.nondet_13 Int)
    (peterson.res.nondet_12 Int)
    (peterson.res.nondet_11 Int)
    (peterson.res.nondet_10 Int)
    (peterson.res.nondet_9 Int)
    (peterson.res.nondet_8 Int)
    (peterson.res.nondet_7 Int)
    (peterson.res.nondet_6 Int)
    (peterson.res.nondet_5 Int)
    (peterson.res.nondet_4 Int)
    (peterson.res.nondet_3 Int)
    (peterson.res.nondet_2 Int)
    (peterson.res.nondet_1 Int)
    (peterson.res.nondet_0 Int)
    (peterson.usr.x0_a_0 Int)
    (peterson.usr.x1_a_0 Int)
    (peterson.usr.x2_a_0 Int)
    (peterson.usr.x3_a_0 Int)
    (peterson.usr.x4_a_0 Int)
    (peterson.usr.x5_a_0 Int)
    (peterson.usr.x6_a_0 Int)
    (peterson.usr.x7_a_0 Int)
    (peterson.usr.x8_a_0 Int)
    (peterson.usr.x9_a_0 Int)
    (peterson.usr.x10_a_0 Int)
    (peterson.usr.x11_a_0 Int)
    (peterson.usr.x12_a_0 Int)
    (peterson.usr.x13_a_0 Int)
    (peterson.res.init_flag_a_0 Bool)
  ) Bool
  
  (and
   (= peterson.usr.x0_a_0 1)
   (let
    ((X1
      Bool (let
            ((X1 Int peterson.res.nondet_1) (X2 Int peterson.res.nondet_0))
            (and (>= X2 1) (>= X1 1)))))
    (and
     (= peterson.usr.x4_a_0 1)
     (let
      ((X2
        Bool (let
              ((X2 Int peterson.res.nondet_11)
               (X3 Int peterson.res.nondet_10))
              (and (>= X3 1) (>= X2 1)))))
      (and
       (= peterson.usr.x3_a_0 0)
       (let
        ((X3
          Bool (let
                ((X3 Int peterson.res.nondet_7)
                 (X4 Int peterson.res.nondet_6))
                (and (>= X4 1) (>= X3 1)))))
        (and
         (= peterson.usr.x2_a_0 0)
         (let
          ((X4
            Bool (let
                  ((X4 Int peterson.res.nondet_3)
                   (X5 Int peterson.res.nondet_2))
                  (and (>= X5 1) (>= X4 1)))))
          (and
           (= peterson.usr.x1_a_0 0)
           (let
            ((X5
              Bool (let
                    ((X5 Int peterson.res.nondet_5)
                     (X6 Int peterson.res.nondet_4))
                    (and (>= X6 1) (>= X5 1)))))
            (and
             (= peterson.usr.x7_a_0 1)
             (let
              ((X6
                Bool (let
                      ((X6 Int peterson.res.nondet_15)
                       (X7 Int peterson.res.nondet_14))
                      (and (>= X7 1) (>= X6 1)))))
              (and
               (= peterson.usr.x11_a_0 0)
               (let
                ((X7
                  Bool (let
                        ((X7 Int peterson.res.nondet_13)
                         (X8 Int peterson.res.nondet_12))
                        (and (>= X8 1) (>= X7 1)))))
                (and
                 (= peterson.usr.x9_a_0 1)
                 (let
                  ((X8
                    Bool (let
                          ((X8 Int peterson.res.nondet_23)
                           (X9 Int peterson.res.nondet_22))
                          (and (>= X9 1) (>= X8 1)))))
                  (and
                   (= peterson.usr.x8_a_0 0)
                   (= peterson.usr.x13_a_0 0)
                   (let
                    ((X9
                      Bool (let
                            ((X9 Int peterson.res.nondet_19)
                             (X10 Int peterson.res.nondet_18))
                            (and (>= X10 1) (>= X9 1)))))
                    (and
                     (= peterson.usr.x12_a_0 0)
                     (let
                      ((X10
                        Bool (let
                              ((X10 Int peterson.res.nondet_17)
                               (X11 Int peterson.res.nondet_16))
                              (and (>= X11 1) (>= X10 1)))))
                      (and
                       (= peterson.usr.x6_a_0 0)
                       (let
                        ((X11
                          Bool (let
                                ((X11 Int peterson.res.nondet_21)
                                 (X12 Int peterson.res.nondet_20))
                                (and (>= X12 1) (>= X11 1)))))
                        (and
                         (= peterson.usr.x10_a_0 1)
                         (let
                          ((X12
                            Bool (let
                                  ((X12 Int peterson.res.nondet_9)
                                   (X13 Int peterson.res.nondet_8))
                                  (and (>= X13 1) (>= X12 1)))))
                          (and
                           (= peterson.usr.x5_a_0 0)
                           peterson.res.init_flag_a_0)))))))))))))))))))))))))
)

(define-fun
  __node_trans_peterson_0 (
    (peterson.usr.e01_a_1 Bool)
    (peterson.usr.e02_a_1 Bool)
    (peterson.usr.e03_a_1 Bool)
    (peterson.usr.e04_a_1 Bool)
    (peterson.usr.e05_a_1 Bool)
    (peterson.usr.e06_a_1 Bool)
    (peterson.usr.e07_a_1 Bool)
    (peterson.usr.e08_a_1 Bool)
    (peterson.usr.e09_a_1 Bool)
    (peterson.usr.e10_a_1 Bool)
    (peterson.usr.e11_a_1 Bool)
    (peterson.usr.e12_a_1 Bool)
    (peterson.res.nondet_23 Int)
    (peterson.res.nondet_22 Int)
    (peterson.res.nondet_21 Int)
    (peterson.res.nondet_20 Int)
    ...
    (peterson.res.nondet_1 Int)
    (peterson.res.nondet_0 Int)
    (peterson.usr.x0_a_1 Int)
    (peterson.usr.x1_a_1 Int)
    (peterson.usr.x2_a_1 Int)
    (peterson.usr.x3_a_1 Int)
    (peterson.usr.x4_a_1 Int)
    (peterson.usr.x5_a_1 Int)
    (peterson.usr.x6_a_1 Int)
    (peterson.usr.x7_a_1 Int)
    (peterson.usr.x8_a_1 Int)
    (peterson.usr.x9_a_1 Int)
    (peterson.usr.x10_a_1 Int)
    (peterson.usr.x11_a_1 Int)
    (peterson.usr.x12_a_1 Int)
    (peterson.usr.x13_a_1 Int)
    (peterson.res.init_flag_a_1 Bool)
    (peterson.usr.e01_a_0 Bool)
    (peterson.usr.e02_a_0 Bool)
    (peterson.usr.e03_a_0 Bool)
    (peterson.usr.e04_a_0 Bool)
  ...
  (let
   ((X1 Bool (and (>= peterson.usr.x3_a_0 1) (>= peterson.usr.x5_a_0 1))))
   (let
    ((X2 Bool (and (>= peterson.usr.x0_a_0 1) (>= peterson.usr.x4_a_0 1))))
    (and
     (=
      peterson.usr.x0_a_1
      (ite
       peterson.usr.e01_a_1
       (ite X2 (- peterson.usr.x0_a_0 1) peterson.usr.x0_a_0)
       (ite
        peterson.usr.e06_a_1
        (ite X1 (+ peterson.usr.x0_a_0 1) peterson.usr.x0_a_0)
        peterson.usr.x0_a_0)))
     (=
      peterson.usr.x4_a_1
      (ite
       peterson.usr.e01_a_1
       (ite X2 (- peterson.usr.x4_a_0 1) peterson.usr.x4_a_0)
       (ite
        peterson.usr.e06_a_1
        (ite X1 (+ peterson.usr.x4_a_0 1) peterson.usr.x4_a_0)
        peterson.usr.x4_a_0)))
     (let
      ((X3 Bool (and (>= peterson.usr.x2_a_0 1) (>= peterson.usr.x6_a_0 1))))
      (let
       ((X4 Bool (and (>= peterson.usr.x2_a_0 1) (>= peterson.usr.x9_a_0 1))))
       (and
        (=
         peterson.usr.x3_a_1
         (ite
          peterson.usr.e04_a_1
          (ite X4 (+ peterson.usr.x3_a_0 1) peterson.usr.x3_a_0)
          (ite
           peterson.usr.e05_a_1
           (ite X3 (+ peterson.usr.x3_a_0 1) peterson.usr.x3_a_0)
           (ite
            peterson.usr.e06_a_1
            (ite X1 (- peterson.usr.x3_a_0 1) peterson.usr.x3_a_0)
            peterson.usr.x3_a_0))))
        (let
         ((X5 Bool (and (>= peterson.usr.x1_a_0 1) (>= peterson.usr.x7_a_0 1))))
         (let
          ((X6 Bool (and (>= peterson.usr.x1_a_0 1) (>= peterson.usr.x6_a_0 1))))
          (and
           (=
            peterson.usr.x2_a_1
            (ite
             peterson.usr.e02_a_1
             (ite X6 (+ peterson.usr.x2_a_0 1) peterson.usr.x2_a_0)
             (ite
              peterson.usr.e03_a_1
              (ite X5 (+ peterson.usr.x2_a_0 1) peterson.usr.x2_a_0)
              (ite
               peterson.usr.e04_a_1
               (ite X4 (- peterson.usr.x2_a_0 1) peterson.usr.x2_a_0)
               (ite
                peterson.usr.e05_a_1
                (ite X3 (- peterson.usr.x2_a_0 1) peterson.usr.x2_a_0)
                peterson.usr.x2_a_0)))))
           (=
            peterson.usr.x1_a_1
            (ite
             peterson.usr.e01_a_1
             (ite X2 (+ peterson.usr.x1_a_0 1) peterson.usr.x1_a_0)
             (ite
              peterson.usr.e02_a_1
              (ite X6 (- peterson.usr.x1_a_0 1) peterson.usr.x1_a_0)
              (ite
               peterson.usr.e03_a_1
               (ite X5 (- peterson.usr.x1_a_0 1) peterson.usr.x1_a_0)
               peterson.usr.x1_a_0))))
           (let
            ((X7
              Bool (and (>= peterson.usr.x7_a_0 1) (>= peterson.usr.x11_a_0 1))))
            (and
             (=
              peterson.usr.x7_a_1
              (ite
               peterson.usr.e02_a_1
               (ite X6 (+ peterson.usr.x7_a_0 1) peterson.usr.x7_a_0)
               (ite
                peterson.usr.e08_a_1
                (ite X7 (- peterson.usr.x7_a_0 1) peterson.usr.x7_a_0)
                peterson.usr.x7_a_0)))
             (let
              ((X8
                Bool (and (>= peterson.usr.x6_a_0 1) (>= peterson.usr.x11_a_0 1))))
              (let
               ((X9
                 Bool (and
                       (>= peterson.usr.x9_a_0 1)
               ...
               (and
                (=
                 peterson.usr.x11_a_1
                 (ite
                  peterson.usr.e07_a_1
                  (ite X9 (+ peterson.usr.x11_a_0 1) peterson.usr.x11_a_0)
                  (ite
                   peterson.usr.e08_a_1
                   (ite X7 (- peterson.usr.x11_a_0 1) peterson.usr.x11_a_0)
                   (ite
                    peterson.usr.e09_a_1
                    (ite X8 (- peterson.usr.x11_a_0 1) peterson.usr.x11_a_0)
                    peterson.usr.x11_a_0))))
                (let
                 ((X10
                   Bool (and
                         (>= peterson.usr.x8_a_0 1)
                         (>= peterson.usr.x13_a_0 1))))
                 (and
                  (=
                   peterson.usr.x9_a_1
                   (ite
                    peterson.usr.e07_a_1
                    (ite X9 (- peterson.usr.x9_a_0 1) peterson.usr.x9_a_0)
                    (ite
                     peterson.usr.e12_a_1
                     (ite X10 (+ peterson.usr.x9_a_0 1) peterson.usr.x9_a_0)
                     peterson.usr.x9_a_0)))
                  (=
                   peterson.usr.x8_a_1
                   (ite
                    peterson.usr.e07_a_1
                    (ite X9 (+ peterson.usr.x8_a_0 1) peterson.usr.x8_a_0)
                    (ite
                     peterson.usr.e12_a_1
                     (ite X10 (- peterson.usr.x8_a_0 1) peterson.usr.x8_a_0)
                     peterson.usr.x8_a_0)))
                  (let
                   ((X11
                     Bool (and
                           (>= peterson.usr.x7_a_0 1)
                           (>= peterson.usr.x12_a_0 1))))
                   (let
                    ((X12
                      Bool (and
                            (>= peterson.usr.x4_a_0 1)
                    ...
                    (and
                     (=
                      peterson.usr.x13_a_1
                      (ite
                       peterson.usr.e10_a_1
                       (ite X12 (+ peterson.usr.x13_a_0 1) peterson.usr.x13_a_0)
                       (ite
                        peterson.usr.e11_a_1
                        (ite X11 (+ peterson.usr.x13_a_0 1) peterson.usr.x13_a_0)
                        (ite
                         peterson.usr.e12_a_1
                         (ite
                          X10
                          (- peterson.usr.x13_a_0 1)
                          peterson.usr.x13_a_0)
                         peterson.usr.x13_a_0))))
                     (=
                      peterson.usr.x12_a_1
                      (ite
                       peterson.usr.e08_a_1
                       (ite X7 (+ peterson.usr.x12_a_0 1) peterson.usr.x12_a_0)
                       (ite
                        peterson.usr.e09_a_1
                        (ite X8 (+ peterson.usr.x12_a_0 1) peterson.usr.x12_a_0)
                        (ite
                         peterson.usr.e10_a_1
                         (ite
                          X12
                     ...
                     (=
                      ...
                      (ite
                       peterson.usr.e02_a_1
                       (ite X6 (- peterson.usr.x6_a_0 1) peterson.usr.x6_a_0)
                       (ite
                        peterson.usr.e08_a_1
                        (ite X7 (+ peterson.usr.x6_a_0 1) peterson.usr.x6_a_0)
                        peterson.usr.x6_a_0)))
                     (=
                      peterson.usr.x10_a_1
                      (ite
                       peterson.usr.e07_a_1
                       (ite X9 (- peterson.usr.x10_a_0 1) peterson.usr.x10_a_0)
                       (ite
                        peterson.usr.e12_a_1
                        (ite X10 (+ peterson.usr.x10_a_0 1) peterson.usr.x10_a_0)
                        peterson.usr.x10_a_0)))
                     (=
                      peterson.usr.x5_a_1
                      (ite
                       peterson.usr.e01_a_1
                       (ite X2 (+ peterson.usr.x5_a_0 1) peterson.usr.x5_a_0)
                       (ite
                        peterson.usr.e06_a_1
                        (ite X1 (- peterson.usr.x5_a_0 1) peterson.usr.x5_a_0)
                        peterson.usr.x5_a_0)))
                     (not peterson.res.init_flag_a_1))))))))))))))))))))
)
...
(define-fun
  ...
  (let
   ...
   (let
    ((X2 Int top.res.abs_2_a_0))
    (let
     ((X3 Int top.res.abs_1_a_0))
     (let
      ((X4 Int top.res.abs_0_a_0))
      (and
       (=
        top.res.abs_15_a_0
        (and
         (and
          (and (and top.res.abs_14_a_0 (< X4 32767)) (< X3 32767))
          (< X2 32767))
         (< X1 32767)))
       (let
        ((X5 Bool top.res.abs_16_a_0))
        (and
         (=
          top.usr.OK_a_0
          (=> X5 (and (and (and (>= X4 0) (>= X3 0)) (>= X2 0)) (>= X1 0))))
         (__node_init_peterson_0
          top.usr.e01_a_0
          top.usr.e02_a_0
          top.usr.e03_a_0
     ...
     (let
      ...
      (and
       (=
        ...
        (and
         (and
          (and (and top.res.abs_14_a_1 (< X4 32767)) (< X3 32767))
          (< X2 32767))
         (< X1 32767)))
       (let
        ((X5 Bool top.res.abs_16_a_1))
        (and
         (=
          top.usr.OK_a_1
          (=> X5 (and (and (and (>= X4 0) (>= X3 0)) (>= X2 0)) (>= X1 0))))
...
(declare-primed-var top.res.abs_13 Int)
     ...
     (let
      ...
      (and
       (=
        ...
        (and
         (and
          (and (and top.res.abs_14 (< X4 32767)) (< X3 32767))
          (< X2 32767))
         (< X1 32767)))
       (let
        ((X5 Bool top.res.abs_16))
        (and
         (=
          top.usr.OK
          (=> X5 (and (and (and (>= X4 0) (>= X3 0)) (>= X2 0)) (>= X1 0))))
         (__node_init_peterson_0
          ...
          top.res.abs_13
          top.res.inst_2)
         (__node_init_Sofar_0 top.res.abs_15 top.res.abs_16 top.res.inst_1)
         (__node_init_excludes12_0
          top.usr.e01
          top.usr.e02
          top.usr.e03
