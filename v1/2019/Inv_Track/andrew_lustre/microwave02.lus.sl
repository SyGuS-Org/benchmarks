...
(define-fun
  ...
  (let
   ((X1 Int 0))
   (let
    ((X2 Int (ite (not (= X1 4)) 4 X1)))
    (and
     (= top.usr.OK_a_0 (or (and (>= X2 1) (<= X2 3)) (= X2 4)))
     (let
      ((X3 Int 0))
      (and
                      ...
                      (and
                       ...
                       (and
                        ...
                        (ite
                         ...
                         false))))))
              (let
               ((X9 Int (ite X8 (ite (= X1 4) 0 X1) X1)))
               (let
                  ...
                  (let
                   ...
                   (let
                    ...
                    (let
                     ...
                     (let
                      ((X16 Int (ite X15 (ite (not (= X14 3)) 3 X14) X14)))
                      (let
                       ((X17 Int (ite X8 X16 X9)))
                       (let
                        ((X18 Int (ite X4 top.impl.usr.STEPS_TO_COOK_a_0 X3)))
                        (let
                         ((X19
                           Bool (and (and (= X17 2) (<= X18 0)) (= X17 2))))
                         (let
                          ((X20
                            Int (ite
                                 X19
                                 (ite (and (>= X17 1) (<= X17 3)) 0 X17)
                                 X17)))
                          (let
                           ((X21
                             Int (ite X19 (ite (not (= X20 4)) 4 X20) X20)))
                           (let
                            ((X22
                              Bool (and
                                    (= X21 3)
                                    (and
                                     ...
                                     (not X19)))))
                            (let
                             ((X23 Int (ite X22 (ite (= X21 3) 1 X21) X21)))
                             (let
                              ((X24
                                Int (ite X22 (ite (not (= X23 2)) 2 X23) X23)))
                              (let
                               ((X25 Bool (or X22 X19)))
                               (let
                                ((X26 Bool top.usr.KP_CLEAR_a_0))
                                (let
                                 ((X27 Int (ite (not X26) 0 1)))
                                 (let
                                  ((X28
                                    Bool (and
                                          (and
...
(define-fun
  ...
  (let
   ...
   (let
    ((X2 Int (ite (not (= X1 4)) 4 X1)))
    (and
     (= top.usr.OK_a_1 (or (and (>= X2 1) (<= X2 3)) (= X2 4)))
     (let
      ((X3 Int top.impl.usr.chart_microwave_mode_logic_steps_remaining_a_0))
      (and
       (=
                      ...
                      (ite
                       ...
                       (ite
                        ...
                        (ite
                         (and
                          top.impl.usr.KP_51_a_1
                          (not top.impl.usr.KP_51_a_0))
                         5
                         (ite
                          (and
                           top.impl.usr.KP_61_a_1
                           (not top.impl.usr.KP_61_a_0))
                          6
                          (ite
                           (and
                            top.impl.usr.KP_71_a_1
                   ...
                   (let
                    ...
                    (let
                     ...
                     (let
                      ((X17 Int (ite X8 X16 X9)))
                      (let
                       ((X18 Int (ite X4 top.impl.usr.STEPS_TO_COOK_a_1 X3)))
                       (let
                        ((X19
                          Bool (and (and (= X17 2) (<= X18 0)) (= X17 2))))
                        (let
...
(define-fun
  ...
  (let
   ...
   (let
    ((X2 Int (ite (not (= X1 4)) 4 X1)))
    (and
     (= top.usr.OK (or (and (>= X2 1) (<= X2 3)) (= X2 4)))
     (let
      ((X3 Int 0))
      (and
                    ...
                    (let
                     ...
                     (let
                      ...
                      (let
                       ((X17 Int (ite X8 X16 X9)))
                       (let
                        ((X18 Int (ite X4 top.impl.usr.STEPS_TO_COOK X3)))
                        (let
                         ((X19
                           Bool (and (and (= X17 2) (<= X18 0)) (= X17 2))))
                         (let
      ...
      (let
       ...
       (and
        ...
        (let
         ((X4 Bool (= X1 4)))
         (let
          ((X5 Bool (and top.usr.KP_START! (not top.usr.KP_START))))
          (let
           ((X6 Int (ite (not X5) 0 1)))
           (let
            ((X7
