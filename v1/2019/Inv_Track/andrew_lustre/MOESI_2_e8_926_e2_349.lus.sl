        ...
        (or
         (and
          (and
           ...
           excludes4.usr.X1_a_0)
          excludes4.usr.X3_a_0)
        ...
        (or
         (and
          (and
           ...
           excludes4.usr.X1_a_1)
          excludes4.usr.X3_a_1)
...
(define-fun
  ...
  (let
   ...
   (let
    ((X2 Bool (>= (+ (- moesi.usr.shared_mo_a_0 1) moesi.usr.owned_mo_a_0) 1)))
    (let
   ...
   (let
    ...
    (let
     ...
     (let
      ...
      (let
       ((X4 Int top.res.abs_3_a_0))
       (let
        ((X5 Int top.res.abs_4_a_0))
        (let
         ((X6 Bool top.res.abs_7_a_0))
         (and
          (= top.res.abs_8_a_0 (+ (+ (+ (+ X1 X2) X3) X4) X5))
          (__node_init_moesi_0
      ...
      (let
       ...
       (let
        ...
        (and
         (=
          top.usr.OK_a_1
          (=> X1 (= (+ (+ (+ (+ X6 X5) X4) X3) X2) top.res.abs_8_a_0)))
         (= top.res.abs_8_a_1 (+ (+ (+ (+ X6 X5) X4) X3) X2))
         (__node_trans_moesi_0
     ...
     (let
      ...
      (let
       ...
       (let
        ...
        (let
         ((X6 Bool top.res.abs_7))
         (and
          (= top.res.abs_8 (+ (+ (+ (+ X1 X2) X3) X4) X5))
          (__node_init_moesi_0
       ...
       (let
        ...
        (let
         ...
         (and
          (=
           top.usr.OK!
           (=> X1 (= (+ (+ (+ (+ X6 X5) X4) X3) X2) top.res.abs_8)))
          (= top.res.abs_8! (+ (+ (+ (+ X6 X5) X4) X3) X2))
          (__node_trans_moesi_0
           top.usr.init_invalid_mo!
           top.usr.etat_mo1!
           top.usr.etat_mo2!
