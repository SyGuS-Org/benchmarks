      ...
      ((X4
        Bool (and
              ...
              (>=
               (+
                (+
                 (+ (- DRAGON.usr.dirty_a_0 DRAGON.usr.shared_a_0) 1)
                 DRAGON.usr.exclusive_a_0)
                DRAGON.usr.shared_dirty_a_0)
               1))))
      (let
  ...
  (and
   ...
   (let
    ...
    (let
     ...
     (let
      ((X3 Int top.res.abs_4_a_0))
      (let
       ((X4 Bool (=> X1 (<= X3 top.res.abs_10_a_0))))
       (let
        ((X5 Int top.res.abs_3_a_0))
        (let
         ((X6 Bool (=> X1 (<= X5 top.res.abs_10_a_0))))
         (let
          ((X7 Int top.res.abs_2_a_0))
          (let
           ((X8 Bool (=> X1 (<= X7 top.res.abs_10_a_0))))
           (let
            ((X9 Int top.res.abs_1_a_0))
            (let
             ((X10 Bool (=> X1 (<= X9 top.res.abs_10_a_0))))
             (let
              ((X11 Bool (=> X1 (>= X3 0))))
              (let
               ((X12 Bool (=> X1 (>= X5 0))))
               (let
                ((X13 Bool (=> X1 (>= X7 0))))
                (let
                 ((X14 Int top.res.abs_0_a_0))
                 (let
                  ((X15 Bool (=> X1 (>= X14 0))))
                  (let
                   ((X16 Bool (=> X1 (>= X9 0))))
                   (let
                    ((X17 Bool (=> X1 (or (< X5 1) (< X9 1)))))
                    (let
                     ((X18 Bool (=> X1 (<= X5 1))))
                     (let
                      ((X19
                         ...
                         (=
                          ...
                          (and
                           (and
                            ...
                            X6)
                           X4))
                         (= top.res.abs_9_a_0 (+ (+ (+ (+ X14 X9) X7) X5) X3))
                         (__node_init_DRAGON_0
                          top.usr.e01_a_0
                          top.usr.e02_a_0
                          top.usr.e03_a_0
   ...
   (let
    ...
    (let
     ...
     (let
      ...
      (let
       ((X4 Bool (=> X1 (<= X3 top.res.abs_10_a_1))))
       (let
        ((X5 Int top.res.abs_3_a_1))
        (let
         ((X6 Bool (=> X1 (<= X5 top.res.abs_10_a_1))))
         (let
          ((X7 Int top.res.abs_2_a_1))
          (let
           ((X8 Bool (=> X1 (<= X7 top.res.abs_10_a_1))))
           (let
            ((X9 Int top.res.abs_1_a_1))
            (let
             ((X10 Bool (=> X1 (<= X9 top.res.abs_10_a_1))))
             (let
              ((X11 Bool (=> X1 (>= X3 0))))
              (let
               ((X12 Bool (=> X1 (>= X5 0))))
                         ...
                         (=
                          ...
                          (and
                           (and
                            ...
                            X6)
                           X4))
                         (= top.res.abs_9_a_1 (+ (+ (+ (+ X14 X9) X7) X5) X3))
                         (__node_trans_DRAGON_0
                          top.usr.e01_a_1
                          top.usr.e02_a_1
                          top.usr.e03_a_1
...
(declare-primed-var top.res.inst_3 Int)
   ...
   (let
    ...
    (let
     ...
     (let
      ...
      (let
       ((X4 Bool (=> X1 (<= X3 top.res.abs_10))))
       (let
        ((X5 Int top.res.abs_3))
        (let
         ((X6 Bool (=> X1 (<= X5 top.res.abs_10))))
         (let
          ((X7 Int top.res.abs_2))
          (let
           ((X8 Bool (=> X1 (<= X7 top.res.abs_10))))
           (let
            ((X9 Int top.res.abs_1))
            (let
             ((X10 Bool (=> X1 (<= X9 top.res.abs_10))))
             (let
              ((X11 Bool (=> X1 (>= X3 0))))
              (let
               ((X12 Bool (=> X1 (>= X5 0))))
