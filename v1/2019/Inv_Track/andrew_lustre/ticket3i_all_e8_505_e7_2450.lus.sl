...
(define-fun
  __node_init_ticket3i_0 (
    (ticket3i.usr.e1_a_0 Bool)
    (ticket3i.usr.e2_a_0 Bool)
    (ticket3i.usr.e3_a_0 Bool)
    (ticket3i.usr.e4_a_0 Bool)
    (ticket3i.usr.e5_a_0 Bool)
    (ticket3i.usr.e6_a_0 Bool)
    (ticket3i.usr.e7_a_0 Bool)
    (ticket3i.usr.e8_a_0 Bool)
    (ticket3i.usr.e9_a_0 Bool)
    (ticket3i.usr.init_a1_a_0 Int)
    (ticket3i.usr.init_a2_a_0 Int)
    (ticket3i.usr.init_a3_a_0 Int)
    (ticket3i.usr.init_t_a_0 Int)
    (ticket3i.res.nondet_11 Int)
    (ticket3i.res.nondet_10 Int)
    (ticket3i.res.nondet_9 Int)
    (ticket3i.res.nondet_8 Int)
    (ticket3i.res.nondet_7 Int)
    (ticket3i.res.nondet_6 Int)
    (ticket3i.res.nondet_5 Int)
    (ticket3i.res.nondet_4 Int)
    (ticket3i.res.nondet_3 Int)
    (ticket3i.res.nondet_2 Int)
    (ticket3i.res.nondet_1 Int)
    (ticket3i.res.nondet_0 Int)
    (ticket3i.usr.p1_a_0 Int)
    (ticket3i.usr.p2_a_0 Int)
    (ticket3i.usr.p3_a_0 Int)
    (ticket3i.usr.t_a_0 Int)
    (ticket3i.usr.s_a_0 Int)
    (ticket3i.usr.a1_a_0 Int)
    (ticket3i.usr.a2_a_0 Int)
    (ticket3i.usr.a3_a_0 Int)
    (ticket3i.usr.erreur_ticket3i_a_0 Bool)
    (ticket3i.res.init_flag_a_0 Bool)
  ) Bool
  
  (and
   (= ticket3i.usr.p1_a_0 0)
   (let
    ((X1 Bool (let ((X1 Int ticket3i.res.nondet_0)) (= X1 0))))
    (and
     (= ticket3i.usr.a1_a_0 ticket3i.usr.init_a1_a_0)
     (let
      ((X2
        Bool (let
              ((X2 Int ticket3i.res.nondet_2) (X3 Int ticket3i.res.nondet_1))
              (and (= X3 1) (>= X2 ticket3i.usr.a1_a_0)))))
      (and
       (= ticket3i.usr.t_a_0 ticket3i.usr.init_t_a_0)
       (= ticket3i.usr.s_a_0 ticket3i.usr.t_a_0)
       (let
        ((X3 Bool (let ((X3 Int ticket3i.res.nondet_4)) (= X3 0))))
        (and
         (= ticket3i.usr.p2_a_0 0)
         (= ticket3i.usr.a2_a_0 ticket3i.usr.init_a2_a_0)
         (let
          ((X4
            Bool (let
                  ((X4 Int ticket3i.res.nondet_6)
                   (X5 Int ticket3i.res.nondet_5))
                  (and (= X5 1) (>= X4 ticket3i.usr.a2_a_0)))))
          (let
           ((X5 Bool (let ((X5 Int ticket3i.res.nondet_7)) (= X5 2))))
           (let
            ((X6 Bool (let ((X6 Int ticket3i.res.nondet_8)) (= X6 0))))
            (and
             (= ticket3i.usr.p3_a_0 0)
             (= ticket3i.usr.a3_a_0 ticket3i.usr.init_a3_a_0)
             (let
              ((X7
                Bool (let
                      ((X7 Int ticket3i.res.nondet_10)
                       (X8 Int ticket3i.res.nondet_9))
                      (and (= X8 1) (>= X7 ticket3i.usr.a3_a_0)))))
              (let
               ((X8 Bool (let ((X8 Int ticket3i.res.nondet_11)) (= X8 2))))
               (let
                ((X9 Bool (let ((X9 Int ticket3i.res.nondet_3)) (= X9 2))))
                (and
                 (=
                  ticket3i.usr.erreur_ticket3i_a_0
                  (ite
                   (or
                    (and (>= ticket3i.usr.p1_a_0 3) (>= ticket3i.usr.p2_a_0 3))
                    (>= ticket3i.usr.p3_a_0 3))
                   true
                   false))
                 ticket3i.res.init_flag_a_0)))))))))))))))
)

(define-fun
  __node_trans_ticket3i_0 (
    (ticket3i.usr.e1_a_1 Bool)
    (ticket3i.usr.e2_a_1 Bool)
    (ticket3i.usr.e3_a_1 Bool)
    (ticket3i.usr.e4_a_1 Bool)
    (ticket3i.usr.e5_a_1 Bool)
    (ticket3i.usr.e6_a_1 Bool)
    (ticket3i.usr.e7_a_1 Bool)
    (ticket3i.usr.e8_a_1 Bool)
    (ticket3i.usr.e9_a_1 Bool)
    (ticket3i.usr.init_a1_a_1 Int)
    (ticket3i.usr.init_a2_a_1 Int)
    (ticket3i.usr.init_a3_a_1 Int)
    (ticket3i.usr.init_t_a_1 Int)
    (ticket3i.res.nondet_11 Int)
    (ticket3i.res.nondet_10 Int)
    (ticket3i.res.nondet_9 Int)
    (ticket3i.res.nondet_8 Int)
    ...
    (ticket3i.res.nondet_1 Int)
    (ticket3i.res.nondet_0 Int)
    (ticket3i.usr.p1_a_1 Int)
    (ticket3i.usr.p2_a_1 Int)
    (ticket3i.usr.p3_a_1 Int)
    (ticket3i.usr.t_a_1 Int)
    (ticket3i.usr.s_a_1 Int)
    (ticket3i.usr.a1_a_1 Int)
    (ticket3i.usr.a2_a_1 Int)
    (ticket3i.usr.a3_a_1 Int)
    (ticket3i.usr.erreur_ticket3i_a_1 Bool)
    (ticket3i.res.init_flag_a_1 Bool)
    (ticket3i.usr.e1_a_0 Bool)
    (ticket3i.usr.e2_a_0 Bool)
    (ticket3i.usr.e3_a_0 Bool)
    (ticket3i.usr.e4_a_0 Bool)
  ...
  (let
   ((X1 Bool (= ticket3i.usr.p1_a_0 2)))
   (let
    ((X2 Bool (= ticket3i.usr.p1_a_0 0)))
    (and
     (=
      ticket3i.usr.a1_a_1
      (ite
       ticket3i.usr.e1_a_1
       (ite X2 ticket3i.usr.t_a_0 ticket3i.usr.a1_a_0)
       ticket3i.usr.a1_a_0))
     (let
      ((X3
        Bool (and
              (= ticket3i.usr.p1_a_0 1)
              (>= ticket3i.usr.s_a_0 ticket3i.usr.a1_a_1))))
      (and
       (=
        ticket3i.usr.p1_a_1
        (ite
         ticket3i.usr.e1_a_1
         (ite X2 1 ticket3i.usr.p1_a_0)
         (ite
          ticket3i.usr.e2_a_1
          (ite X3 2 ticket3i.usr.p1_a_0)
          (ite
           ticket3i.usr.e3_a_1
           (ite X1 0 ticket3i.usr.p1_a_0)
           ticket3i.usr.p1_a_0))))
       (let
        ((X4 Bool (= ticket3i.usr.p3_a_0 2)))
        (let
         ((X5 Bool (= ticket3i.usr.p2_a_0 2)))
         (and
          (=
           ticket3i.usr.s_a_1
           (ite
            ticket3i.usr.e3_a_1
            (ite X1 (+ ticket3i.usr.s_a_0 1) ticket3i.usr.s_a_0)
            (ite
             ticket3i.usr.e6_a_1
             (ite X5 (+ ticket3i.usr.s_a_0 1) ticket3i.usr.s_a_0)
             (ite
              ticket3i.usr.e9_a_1
              (ite X4 (+ ticket3i.usr.s_a_0 1) ticket3i.usr.s_a_0)
              ticket3i.usr.s_a_0))))
          (let
           ((X6 Bool (= ticket3i.usr.p3_a_0 0)))
           (let
            ((X7 Bool (= ticket3i.usr.p2_a_0 0)))
            (and
             (=
              ticket3i.usr.t_a_1
              (ite
               ticket3i.usr.e1_a_1
               (ite X2 (+ ticket3i.usr.t_a_0 1) ticket3i.usr.t_a_0)
               (ite
                ticket3i.usr.e4_a_1
                (ite X7 (+ ticket3i.usr.t_a_0 1) ticket3i.usr.t_a_0)
                (ite
                 ticket3i.usr.e7_a_1
                 (ite X6 (+ ticket3i.usr.t_a_0 1) ticket3i.usr.t_a_0)
                 ticket3i.usr.t_a_0))))
             (=
              ticket3i.usr.a2_a_1
              (ite
               ticket3i.usr.e4_a_1
               (ite X7 ticket3i.usr.t_a_0 ticket3i.usr.a2_a_0)
               ticket3i.usr.a2_a_0))
             (let
              ((X8
                Bool (and
                      (= ticket3i.usr.p2_a_0 1)
                      (>= ticket3i.usr.s_a_0 ticket3i.usr.a2_a_1))))
              (and
               (=
                ticket3i.usr.p2_a_1
                (ite
                 ticket3i.usr.e4_a_1
                 (ite X7 1 ticket3i.usr.p2_a_0)
                 (ite
                  ticket3i.usr.e5_a_1
                  (ite X8 2 ticket3i.usr.p2_a_0)
                  (ite
                   ticket3i.usr.e6_a_1
                   (ite X5 0 ticket3i.usr.p2_a_0)
                   ticket3i.usr.p2_a_0))))
               (=
                ticket3i.usr.a3_a_1
                (ite
                 ticket3i.usr.e7_a_1
                 (ite X6 ticket3i.usr.t_a_0 ticket3i.usr.a3_a_0)
                 ticket3i.usr.a3_a_0))
               (let
                ((X9
                  Bool (and
                        (= ticket3i.usr.p3_a_0 1)
                        (>= ticket3i.usr.s_a_0 ticket3i.usr.a3_a_1))))
                (and
                 (=
                  ticket3i.usr.p3_a_1
                  (ite
                   ticket3i.usr.e7_a_1
                   (ite X6 1 ticket3i.usr.p3_a_0)
                   (ite
                    ticket3i.usr.e8_a_1
                    (ite X9 2 ticket3i.usr.p3_a_0)
                    (ite
                     ticket3i.usr.e9_a_1
                     (ite X4 0 ticket3i.usr.p3_a_0)
                     ticket3i.usr.p3_a_0))))
                 (=
                  ticket3i.usr.erreur_ticket3i_a_1
                  (ite
                   (or
                    (and (>= ticket3i.usr.p1_a_1 3) (>= ticket3i.usr.p2_a_1 3))
                    (>= ticket3i.usr.p3_a_1 3))
                   true
                   false))
                 (not ticket3i.res.init_flag_a_1))))))))))))))))
)
...
(define-fun
  __node_init_top_0 (
    ...
    (top.usr.e8_a_0 Bool)
    (top.usr.e9_a_0 Bool)
    (top.usr.init_a1_a_0 Int)
    (top.usr.init_a2_a_0 Int)
    (top.usr.init_a3_a_0 Int)
    (top.usr.init_t_a_0 Int)
  ...
  (and
   (=
    ...
    (and
     (and
      (and
       (and top.res.abs_9_a_0 (>= top.usr.init_a1_a_0 0))
       (>= top.usr.init_a2_a_0 0))
      (>= top.usr.init_a3_a_0 0))
     (>= top.usr.init_t_a_0 0)))
   (let
    ((X1 Bool top.res.abs_11_a_0))
    (let
     ((X2 Bool top.res.abs_8_a_0))
     (let
      ((X3 Int top.res.abs_2_a_0))
      (let
       ((X4 Int top.res.abs_1_a_0))
       (let
        ((X5 Int top.res.abs_0_a_0))
        (and
         (=
          top.usr.OK_a_0
          (=>
           ...
           (and
            (and
             (and
              (and
               (and (and (and (not X2) (<= 0 X5)) (<= X5 3)) (<= 0 X4))
               (<= X4 3))
              (<= 0 X3))
             (<= X3 3))
            (<= (+ (+ X5 X4) X3) 9))))
...
(define-fun
  __node_trans_top_0 (
    ...
    (top.usr.e8_a_1 Bool)
    (top.usr.e9_a_1 Bool)
    (top.usr.init_a1_a_1 Int)
    (top.usr.init_a2_a_1 Int)
    (top.usr.init_a3_a_1 Int)
    (top.usr.init_t_a_1 Int)
    (top.res.nondet_11 Int)
    (top.res.nondet_10 Int)
    (top.res.nondet_9 Int)
    (top.res.nondet_8 Int)
  ...
  (and
   (=
    ...
    (and
     (and
      (and
       (and top.res.abs_9_a_1 (>= top.usr.init_a1_a_1 0))
       (>= top.usr.init_a2_a_1 0))
      (>= top.usr.init_a3_a_1 0))
     (>= top.usr.init_t_a_1 0)))
   (let
    ((X1 Bool top.res.abs_11_a_1))
    (let
     ((X2 Bool top.res.abs_8_a_1))
     (let
      ((X3 Int top.res.abs_2_a_1))
      (let
       ((X4 Int top.res.abs_1_a_1))
       (let
        ((X5 Int top.res.abs_0_a_1))
        (and
         (=
          top.usr.OK_a_1
          (=>
...
(declare-primed-var top.usr.init_a1 Int)
(declare-primed-var top.usr.init_a2 Int)
(declare-primed-var top.usr.init_a3 Int)
(declare-primed-var top.usr.init_t Int)
...
(define-fun
  ...
  (and
   (=
    ...
    (and
     (and
      (and (and top.res.abs_9 (>= top.usr.init_a1 0)) (>= top.usr.init_a2 0))
      (>= top.usr.init_a3 0))
     (>= top.usr.init_t 0)))
   (let
    ((X1 Bool top.res.abs_11))
    (let
     ((X2 Bool top.res.abs_8))
     (let
      ((X3 Int top.res.abs_2))
      (let
       ((X4 Int top.res.abs_1))
       (let
        ((X5 Int top.res.abs_0))
        (and
         (=
          top.usr.OK
          (=>
   ...
   (and
    (=
     ...
     (and
      (and
       (and
        (and top.res.abs_9! (>= top.usr.init_a1! 0))
        (>= top.usr.init_a2! 0))
       (>= top.usr.init_a3! 0))
      (>= top.usr.init_t! 0)))
    (let
