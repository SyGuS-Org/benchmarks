...
(define-fun
  __node_init_FirstB_0 (
    (FirstB.usr.X_a_0 Bool)
    (FirstB.usr.First_a_0 Bool)
    (FirstB.res.init_flag_a_0 Bool)
  ) Bool
...
(define-fun
  __node_trans_FirstB_0 (
    (FirstB.usr.X_a_1 Bool)
    (FirstB.usr.First_a_1 Bool)
    (FirstB.res.init_flag_a_1 Bool)
    (FirstB.usr.X_a_0 Bool)
    (FirstB.usr.First_a_0 Bool)
    (FirstB.res.init_flag_a_0 Bool)
  ) Bool
  ...
  (and
   (= FirstB.usr.First_a_1 FirstB.usr.First_a_0)
   (not FirstB.res.init_flag_a_1))
)
    ...
    (not
     (or
      (or
       ...
       (and excludes3.usr.X1_a_0 excludes3.usr.X3_a_0))
  ...
  (and
   (=
    ...
    (not
     (or
      (or
       (and excludes3.usr.X1_a_1 excludes3.usr.X2_a_1)
       (and excludes3.usr.X1_a_1 excludes3.usr.X3_a_1))
...
(define-fun
  ...
  (and
   (= top.usr.OK_a_0 true)
   (= top.impl.usr.o1_a_0 top.res.abs_3_a_0)
   (=
    top.res.abs_8_a_0
    (not (or (or top.usr.etat1_a_0 top.usr.etat2_a_0) top.usr.etat3_a_0)))
   (=
    top.res.abs_6_a_0
    (or
     top.res.abs_5_a_0
   ...
   (let
    ((X1
      Bool (and (and top.res.abs_7_a_0 top.res.abs_9_a_0) (> top.res.abs_10_a_0 0))))
    (and
     (__node_init_PRODUCER_CONSUMMER_0
      top.usr.etat1_a_0
      top.usr.etat2_a_0
      ...
      top.res.abs_4_a_0
      top.res.inst_4_a_0)
     (__node_init_Sofar_0 top.res.abs_6_a_0 top.res.abs_7_a_0 top.res.inst_3_a_0)
     (__node_init_excludes3_0
      top.usr.etat1_a_0
      top.usr.etat2_a_0
      top.usr.etat3_a_0
      top.res.abs_5_a_0
      top.res.inst_2_a_0)
     (__node_init_FirstB_0 top.res.abs_8_a_0 top.res.abs_9_a_0 top.res.inst_1_a_0)
     (__node_init_First_0 top.usr.a_init_a_0 top.res.abs_10_a_0 top.res.inst_0_a_0)
...
(define-fun
  ...
  (and
   (=
    ...
    (or
     top.res.abs_5_a_1
     (not (or (or top.usr.etat1_a_1 top.usr.etat2_a_1) top.usr.etat3_a_1))))
   (let
    ((X1
      Bool (and (and top.res.abs_7_a_1 top.res.abs_9_a_1) (> top.res.abs_10_a_1 0))))
    (and
     (= top.impl.usr.o1_a_1 top.res.abs_3_a_1)
     (=
      top.usr.OK_a_1
      (=>
       X1
       (=>
        (and top.usr.etat1_a_0 top.usr.etat2_a_1)
        (or
         (= top.impl.usr.o1_a_1 (+ top.impl.usr.o1_a_0 1))
         (= top.impl.usr.o1_a_1 top.impl.usr.o1_a_0)))))
     (=
      top.res.abs_8_a_1
      (not (or (or top.usr.etat1_a_1 top.usr.etat2_a_1) top.usr.etat3_a_1)))
     (__node_trans_PRODUCER_CONSUMMER_0
...
(define-fun
  ...
  (and
   (= top.usr.OK true)
   (= top.impl.usr.o1 top.res.abs_3)
   (=
    top.res.abs_8
    (not (or (or top.usr.etat1 top.usr.etat2) top.usr.etat3)))
   (=
    top.res.abs_6
    (or
     top.res.abs_5
     (not (or (or top.usr.etat1 top.usr.etat2) top.usr.etat3))))
   (let
    ((X1 Bool (and (and top.res.abs_7 top.res.abs_9) (> top.res.abs_10 0))))
    (and
     (__node_init_PRODUCER_CONSUMMER_0
      top.usr.etat1
      top.usr.etat2
      ...
      top.res.abs_4
      top.res.inst_4)
     (__node_init_Sofar_0 top.res.abs_6 top.res.abs_7 top.res.inst_3)
     (__node_init_excludes3_0
      top.usr.etat1
      top.usr.etat2
      top.usr.etat3
      top.res.abs_5
      top.res.inst_2)
     (__node_init_FirstB_0 top.res.abs_8 top.res.abs_9 top.res.inst_1)
     (__node_init_First_0 top.usr.a_init top.res.abs_10 top.res.inst_0)
     top.res.init_flag)))
)
...
(define-fun
  ...
  (and
   (and
    ...
    (let
     ((X1
       Bool (and (and top.res.abs_7! top.res.abs_9!) (> top.res.abs_10! 0))))
     (and
      (= top.impl.usr.o1! top.res.abs_3!)
      (=
       top.usr.OK!
       (=>
        X1
        (=>
         (and top.usr.etat1 top.usr.etat2!)
         (or
          (= top.impl.usr.o1! (+ top.impl.usr.o1 1))
          (= top.impl.usr.o1! top.impl.usr.o1)))))
      (=
       top.res.abs_8!
       (not (or (or top.usr.etat1! top.usr.etat2!) top.usr.etat3!)))
      (__node_trans_PRODUCER_CONSUMMER_0
