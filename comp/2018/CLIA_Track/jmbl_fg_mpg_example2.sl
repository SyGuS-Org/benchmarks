...
; if ( 2x -3 <= -2y +4 + z) then min(x,y,z) else mux_(x,y,z) endif

( constraint (  im ( <=  (  plus_2 ( two_times x ) ( minus 3 ) )   ( plus_3 z  ( minus ( two_times y ) )  4    ) ) (  >=  ( eq_1 x y z )  x )  ( <= (eq_1 x y z ) x ) ) )
( constraint (  im ( <=  (  plus_2 ( two_times x ) ( minus 3 ) )   ( plus_3 z  ( minus ( two_times y ) )  4    ) ) (  >=  ( eq_1 x y z )  y )  ( <= (eq_1 x y z ) y ) ) )
( constraint (  im ( <=  (  plus_2 ( two_times x ) ( minus 3 ) )   ( plus_3 z  ( minus ( two_times y ) )  4    ) ) (  >=  ( eq_1 x y z )  z )  ( <= (eq_1 x y z ) z ) ) )
( constraint (  or3 (  =  ( eq_1 x y z )  x ) (  =  ( eq_1 x y z )  y ) (  =  ( eq_1 x y z )  z ) ) )
