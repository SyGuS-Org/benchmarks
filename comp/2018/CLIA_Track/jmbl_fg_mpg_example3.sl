...
( constraint (  im  (>=  ( three_times z)  5  ) 
		       ( im  (  <=  ( two_times x )  y  ) 
		  	      (  =  ( eq2 x y z ) ( plus_4  ( three_times x)  ( minus ( five_times y )) (seven_times z ) 9 ) )
			        (  =  ( eq2 x y z ) ( plus_4 x x  (minus ( nine_times z) ) 5 ) )  
			    )
  		      ( im  (  <=  ( two_times z ) ( plus_3 (minus y) x x ) ) 
			      (  =  ( eq2 x y z ) ( plus_3  (minus ( six_times x) ) ( three_times y )  4 ) )
			      (  =  ( eq2 x y z )  ( plus_3 ( nine_times  (plus_2 x y ) )  (minus z ) 5 ) ) 
			   )
