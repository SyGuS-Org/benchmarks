...
(synth-fun f ((_arg_0 String) (_arg_1 Int)) String
    ...
    (ntInt Int (_arg_1 1 0 -1 0 1 2 3 4 5 (+ ntInt ntInt) (- ntInt ntInt) (str.len ntString) (str.to.int ntString) (ite ntBool ntInt ntInt) (str.indexof ntString ntString ntInt)))
