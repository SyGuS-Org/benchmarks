...
(synth-fun f ((_arg_0 String)) String
    ...
    (ntString String (_arg_0 "" " " "_" "1" "2" "3" "4" "5" "6" "7" "8" "9" "0" (str.++ ntString ntString) (str.replace ntString ntString ntString) (str.at ntString ntInt) (int.to.str ntInt) (ite ntBool ntString ntString) (str.substr ntString ntInt ntInt)))
