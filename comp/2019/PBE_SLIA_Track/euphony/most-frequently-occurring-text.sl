...
(synth-fun f ((_arg_0 String) (_arg_1 String) (_arg_2 String)) String
    ...
    (ntString String (_arg_0 _arg_1 _arg_2 "" " " (str.++ ntString ntString) (str.replace ntString ntString ntString) (str.at ntString ntInt) (int.to.str ntInt) (ite ntBool ntString ntString) (str.substr ntString ntInt ntInt)))
