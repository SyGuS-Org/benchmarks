...
(synth-fun skel ((n142 Bool) (n129 Bool) (n136 Bool) (n126 Bool)) Bool
    ...
    (depth5 Bool ((and depth4 depth4) (or depth4 depth4) (xor depth5 depth5) (not depth5) depth4 n136))
    (depth4 Bool ((and depth3 depth3) (or depth3 depth3) (xor depth4 depth4) (not depth4) depth3 n142 n129 n126))
