...
(define-fun origCir ((n272 Bool) (n218 Bool) (n252 Bool) (n215 Bool)) Bool
    (xor n272 (and (and n252 n218) n215)))
(synth-fun skel ((n272 Bool) (n218 Bool) (n252 Bool) (n215 Bool)) Bool
    ((Start Bool (depth6))
...
(constraint (= (origCir n272 n218 n252 n215) (skel n272 n218 n252 n215)))
