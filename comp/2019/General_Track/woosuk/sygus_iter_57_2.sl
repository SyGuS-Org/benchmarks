...
(synth-fun skel ((n317 Bool) (n330 Bool) (n333 Bool) (n151 Bool)) Bool
    ...
    (depth3 Bool ((and depth2 depth2) (or depth2 depth2) (xor depth3 depth3) (not depth3) depth2 n330))
    (depth2 Bool ((and depth1 depth1) (or depth1 depth1) (xor depth2 depth2) (not depth2) depth1))
    (depth1 Bool ((and depth0 depth0) (or depth0 depth0) (xor depth1 depth1) (not depth1) depth0 n317 n333))
    (depth0 Bool (true false (xor depth0 depth0) (not depth0) n151))))
