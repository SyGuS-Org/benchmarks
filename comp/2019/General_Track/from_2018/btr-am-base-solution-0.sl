...
(synth-fun btr-am ((base (BitVec 32)) (mem (BitVec 32)) (bit (BitVec 32))) (BitVec 32)
    ...
    (Is (BitVec 32) ((Constant (BitVec 32)) (Variable (BitVec 32)) (bvneg Is) (bvnot Is) (bvadd Is Is) (bvand Is Is) (bvlshr Is Is) (bvmul Is Is) (bvor Is Is) (bvshl Is Is) (load-val base Is Start)))))
