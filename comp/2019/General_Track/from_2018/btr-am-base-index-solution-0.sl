...
(define-fun lea ((base (BitVec 32)) (index (BitVec 32))) (BitVec 32)
    (bvadd base index))
(define-fun load-val ((base (BitVec 32)) (index (BitVec 32)) (ptr (BitVec 32)) (mem (BitVec 32))) (BitVec 32)
    (ite (= ptr (lea base index)) mem #x00000000))
(define-fun store ((base (BitVec 32)) (index (BitVec 32)) (ptr (BitVec 32)) (mem (BitVec 32)) (val (BitVec 32))) (BitVec 32)
    (ite (= ptr (lea base index)) val #x00000000))
(define-fun bit-reset-destam-base-index ((base (BitVec 32)) (index (BitVec 32)) (mem (BitVec 32)) (bit (BitVec 32))) (BitVec 32)
    (let ((effective (BitVec 32) (lea base index))) (let ((lv (BitVec 32) (load-val base index effective mem))) (let ((result (BitVec 32) (bit-reset lv bit))) (store base index effective mem result)))))
(synth-fun btr-am ((base (BitVec 32)) (index (BitVec 32)) (mem (BitVec 32)) (bit (BitVec 32))) (BitVec 32)
    ((Start (BitVec 32) ((Variable (BitVec 32)) (store base index Is Start Is)))
    (Is (BitVec 32) ((Constant (BitVec 32)) (Variable (BitVec 32)) (bvadd Is Is) (bvneg Is) (bvnot Is) (bvadd Is Is) (bvand Is Is) (bvlshr Is Is) (bvmul Is Is) (bvor Is Is) (bvshl Is Is) (load-val base index Is Start)))))

(declare-var base (BitVec 32))
(declare-var index (BitVec 32))
