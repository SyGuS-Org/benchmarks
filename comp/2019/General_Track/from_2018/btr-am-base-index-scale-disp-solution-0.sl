...
(define-fun bit-reset-destam-base-index-scale-disp ((base (BitVec 32)) (index (BitVec 32)) (scale (BitVec 32)) (disp (BitVec 32)) (mem (BitVec 32)) (bit (BitVec 32))) (BitVec 32)
    (let ((effective (BitVec 32) (lea base index scale disp))) (let ((lv (BitVec 32) (load-val base index scale disp effective mem))) (let ((result (BitVec 32) (bit-reset lv bit))) (store base index scale disp effective mem result)))))
(synth-fun btr-am ((base (BitVec 32)) (index (BitVec 32)) (scale (BitVec 32)) (disp (BitVec 32)) (mem (BitVec 32)) (bit (BitVec 32))) (BitVec 32)
    ((Start (BitVec 32) ((Variable (BitVec 32)) (store base index scale disp Is Start Is)))
    (Is (BitVec 32) ((Constant (BitVec 32)) (Variable (BitVec 32)) (bvadd Is Is) (bvshl Is Is) (bvneg Is) (bvnot Is) (bvadd Is Is) (bvand Is Is) (bvlshr Is Is) (bvmul Is Is) (bvor Is Is) (bvshl Is Is) (load-val base index scale disp Is Start)))))
