...
(synth-fun btr-am ((base (BitVec 32)) (index (BitVec 32)) (scale (BitVec 32)) (disp (BitVec 32)) (mem (BitVec 32)) (bit (BitVec 32))) (BitVec 32)
    ...
    (Is (BitVec 32) ((Constant (BitVec 32)) (Variable (BitVec 32)) (bvadd Is Is) (bvshl Is Is) (bvsub Is Is) (bvand Is Is) (bvshl Is Is) (load-val base index scale disp Is Start)))))
