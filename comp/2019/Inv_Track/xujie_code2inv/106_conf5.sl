...
(define-fun pre-f ((a Int) (j Int) (conf_0 Int) (conf_1 Int) (conf_2 Int) (conf_3 Int) (conf_4 Int) (k Int) (m Int) (a_0 Int) (j_0 Int) (conf_0_0 Int) (conf_1_0 Int) (conf_2_0 Int) (conf_3_0 Int) (conf_3_1 Int) (conf_3_2 Int) (conf_4_0 Int) (conf_4_1 Int) (conf_4_2 Int) (conf_4_3 Int) (k_0 Int) (k_1 Int) (k_2 Int) (k_3 Int) (m_0 Int) (m_1 Int) (m_2 Int) (m_3 Int)) Bool
    (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= a a_0) (= j j_0)) (= conf_0 conf_0_0)) (= conf_1 conf_1_0)) (= conf_2 conf_2_0)) (= conf_3 conf_3_0)) (= conf_4 conf_4_0)) (= k k_1)) (= m m_0)) (= conf_0_0 1)) (= conf_1_0 3)) (= conf_2_0 8)) (= conf_3_0 2)) (= conf_4_0 4)) (<= a_0 m_0)) (< j_0 1)) (= k_1 0)))
...
(define-fun post-f ((a Int) (j Int) (conf_0 Int) (conf_1 Int) (conf_2 Int) (conf_3 Int) (conf_4 Int) (k Int) (m Int) (a_0 Int) (j_0 Int) (conf_0_0 Int) (conf_1_0 Int) (conf_2_0 Int) (conf_3_0 Int) (conf_3_1 Int) (conf_3_2 Int) (conf_4_0 Int) (conf_4_1 Int) (conf_4_2 Int) (conf_4_3 Int) (k_0 Int) (k_1 Int) (k_2 Int) (k_3 Int) (m_0 Int) (m_1 Int) (m_2 Int) (m_3 Int)) Bool
    (or (not (and (and (and (and (and (and (and (and (= a a_0) (= j j_0)) (= conf_0 conf_0_0)) (= conf_1 conf_1_0)) (= conf_2 conf_2_0)) (= conf_3 conf_3_1)) (= conf_4 conf_4_1)) (= k k_2)) (= m m_1))) (not (and (not (< k_2 1)) (not (>= a_0 m_1))))))
