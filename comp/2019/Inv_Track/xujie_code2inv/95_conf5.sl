...
(define-fun pre-f ((i Int) (j Int) (conf_0 Int) (conf_1 Int) (conf_2 Int) (conf_3 Int) (conf_4 Int) (x Int) (y Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (j_0 Int) (j_1 Int) (j_2 Int) (j_3 Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_1_0 Int) (conf_2_0 Int) (conf_2_1 Int) (conf_2_2 Int) (conf_3_0 Int) (conf_4_0 Int) (x_0 Int) (y_0 Int) (y_1 Int)) Bool
    (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= i i_1) (= j j_1)) (= conf_0 conf_0_0)) (= conf_1 conf_1_0)) (= conf_2 conf_2_0)) (= conf_3 conf_3_0)) (= conf_4 conf_4_0)) (= y y_1)) (= conf_0_0 5)) (= conf_1_0 9)) (= conf_2_0 2)) (= conf_3_0 7)) (= conf_4_0 2)) (= j_1 0)) (= i_1 0)) (= y_1 1)))
...
(define-fun post-f ((i Int) (j Int) (conf_0 Int) (conf_1 Int) (conf_2 Int) (conf_3 Int) (conf_4 Int) (x Int) (y Int) (i_0 Int) (i_1 Int) (i_2 Int) (i_3 Int) (j_0 Int) (j_1 Int) (j_2 Int) (j_3 Int) (conf_0_0 Int) (conf_0_1 Int) (conf_0_2 Int) (conf_1_0 Int) (conf_2_0 Int) (conf_2_1 Int) (conf_2_2 Int) (conf_3_0 Int) (conf_4_0 Int) (x_0 Int) (y_0 Int) (y_1 Int)) Bool
    (or (not (and (and (and (and (and (and (and (and (= i i_2) (= j j_2)) (= conf_0 conf_0_1)) (= conf_1 conf_1_0)) (= conf_2 conf_2_1)) (= conf_3 conf_3_0)) (= conf_4 conf_4_0)) (= x x_0)) (= y y_1))) (not (and (and (not (<= i_2 x_0)) (= y_1 1)) (not (= i_2 j_2))))))
