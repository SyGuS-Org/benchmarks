...
(define-fun init ((top.usr.Delta Int) (top.usr.OK Bool) (top.res.init_flag Bool) (top.res.abs_0 Int) (top.res.abs_1 Bool) (top.res.abs_2 Bool) (top.res.inst_1 Bool) (top.res.inst_0 Bool)) Bool
    (and (= top.res.abs_1 (and (<= (- 1) top.usr.Delta) (<= top.usr.Delta 1))) (let ((X1 Int top.res.abs_0)) (and (and (and (= top.usr.OK (=> top.res.abs_2 (and (<= 0 X1) (<= X1 20)))) (__node_init_Store_0 top.usr.Delta top.res.abs_0 top.res.inst_1)) (__node_init_Sofar_0 top.res.abs_1 top.res.abs_2 top.res.inst_0)) top.res.init_flag))))
(define-fun trans ((top.usr.Delta Int) (top.usr.OK Bool) (top.res.init_flag Bool) (top.res.abs_0 Int) (top.res.abs_1 Bool) (top.res.abs_2 Bool) (top.res.inst_1 Bool) (top.res.inst_0 Bool) (top.usr.Delta! Int) (top.usr.OK! Bool) (top.res.init_flag! Bool) (top.res.abs_0! Int) (top.res.abs_1! Bool) (top.res.abs_2! Bool) (top.res.inst_1! Bool) (top.res.inst_0! Bool)) Bool
    (and (= top.res.abs_1! (and (<= (- 1) top.usr.Delta!) (<= top.usr.Delta! 1))) (let ((X1 Int top.res.abs_0!)) (and (and (and (= top.usr.OK! (=> top.res.abs_2! (and (<= 0 X1) (<= X1 20)))) (__node_trans_Store_0 top.usr.Delta! top.res.abs_0! top.res.inst_1! top.usr.Delta top.res.abs_0 top.res.inst_1)) (__node_trans_Sofar_0 top.res.abs_1! top.res.abs_2! top.res.inst_0! top.res.abs_1 top.res.abs_2 top.res.inst_0)) (not top.res.init_flag!)))))
